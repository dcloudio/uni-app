...
const onCopyUrl = /*#__PURE__*/ createLifeCycleHook(ON_COPY_URL, 2 /* HookFlags.PAGE */);
const onUploadDouyinVideo = /*#__PURE__*/ createLifeCycleHook(ON_UPLOAD_DOUYIN_VIDEO, 2 /* HookFlags.PAGE */);
...
export { formatAppLog, formatLog, getCurrentSubNVue, getSsrGlobalData, onAddToFavorites, onBackPress, onCopyUrl, onError, onExit, onHide, onInit, onLaunch, onLoad, onNavigationBarButtonTap, onNavigationBarSearchInputChanged, onNavigationBarSearchInputClicked, onNavigationBarSearchInputConfirmed, onNavigationBarSearchInputFocusChanged, onPageHide, onPageNotFound, onPageScroll, onPageShow, onPullDownRefresh, onReachBottom, onReady, onResize, onSaveExitState, onShareAppMessage, onShareChat, onShareTimeline, onShow, onTabItemTap, onThemeChange, onUnhandledRejection, onUnload, onUploadDouyinVideo, renderComponentSlot, requireNativePlugin, resolveEasycom, shallowSsrRef, ssrRef };
