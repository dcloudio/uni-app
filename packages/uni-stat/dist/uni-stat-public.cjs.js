...
var uniApp = require('@dcloudio/uni-app');
        ...
        if (typeof (runtime === null || runtime === void 0 ? void 0 : runtime.onBeforeAppRoute) !== 'function') {
            ...
            shared.beforeRouteCallback = (event) => {
                ...
                try {
                    ...
                    uniApp.onAppShow((value) => { var _a; return (_a = getSharedState().sink) === null || _a === void 0 ? void 0 : _a.show(value !== null && value !== void 0 ? value : {}, Date.now()); });
                    uniApp.onAppHide(() => { var _a; return (_a = getSharedState().sink) === null || _a === void 0 ? void 0 : _a.hide(Date.now()); });
                    uniApp.onError((value) => { var _a; return (_a = getSharedState().sink) === null || _a === void 0 ? void 0 : _a.error(value, Date.now()); });
                }
                catch (error) {
