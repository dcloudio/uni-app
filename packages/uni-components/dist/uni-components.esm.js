        ...
        createVNode('div', _hoisted_1, [
          createVNode(
            ...
            [
              createVNode(
                ...
                {
                  class: [
                    { play: !_ctx.playing, pause: _ctx.playing },
                    'uni-audio-button'
                  ],
                  onClick:
                    _cache[1] ||
                    (_cache[1] = (...args) => _ctx.trigger(...args))
                },
                null,
                2
              )
          ...
          createVNode('div', _hoisted_2, [
            createVNode(
              'div',
              _hoisted_3,
              toDisplayString(_ctx.currentTime),
              1
            ),
...
if (pixelRatio !== 1) {
  ...
  proto.fillText = (function(_super) {
    return function() {
      ...
      args[2] *= pixelRatio
      var font2 = this.font
      this.font = font2.replace(/(\d+\.?\d*)(px|em|rem|pt)/g, function(
        w,
        m,
        u
      ) {
...
var script$1 = {
  ...
  methods: {
    ...
    putImageData({ data, x, y, width, height, callbackId }) {
      try {
        if (!height) {
  ...
  return (
    ...
    createBlock(
      ...
      [
        ...
        createVNode('div', _hoisted_2$1, [renderSlot(_ctx.$slots, 'default')]),
        createVNode(
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    createBlock(
      'uni-checkbox',
      mergeProps({ disabled: _ctx.disabled }, _ctx.$attrs, {
      ...
      [
        createVNode('div', _hoisted_1$2, [
          createVNode(
            ...
            {
              class: [
                [_ctx.checkboxChecked ? 'uni-checkbox-input-checked' : ''],
                'uni-checkbox-input'
              ],
...
script$3.__file =
  'packages/uni-components/src/components/checkbox-group/index.vue'
...
var script$4 = {
  ...
  methods: {
    ...
    updateStatus(range) {
      ...
      if (
        keys.length !== Object.keys(this.__status || {}).length ||
        keys.find(key => status[key] !== this.__status[key])
      ) {
      ...
      [
        createVNode(
          'i',
          {
            ...
            style: {
              'font-size': _ctx._converPx(_ctx.size),
              color: _ctx.color
            },
            role: 'img'
          },
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    createBlock(
      ...
      mergeProps(
        {
          onChange: _cache[8] || (_cache[8] = withModifiers(() => {}, ['stop']))
        },
        _ctx.$attrs
      ),
      [
            ...
            withDirectives(
              createVNode(
                'input',
                {
                  ...
                  'onUpdate:modelValue':
                    _cache[1] ||
                    (_cache[1] = $event => (_ctx.valueSync = $event)),
                  ...
                  onFocus:
                    _cache[2] ||
                    (_cache[2] = (...args) => _ctx._onFocus(...args)),
                  onBlur:
                    _cache[3] ||
                    (_cache[3] = (...args) => _ctx._onBlur(...args)),
                  onInput:
                    _cache[4] ||
                    (_cache[4] = withModifiers(
                      (...args) => _ctx._onInput(...args),
                      ['stop']
                    )),
                  onCompositionstart:
                    _cache[5] ||
                    (_cache[5] = (...args) => _ctx._onComposition(...args)),
                  onCompositionend:
                    _cache[6] ||
                    (_cache[6] = (...args) => _ctx._onComposition(...args)),
                  onKeyup:
                    _cache[7] ||
                    (_cache[7] = withModifiers(
                      (...args) => _ctx._onKeyup(...args),
                      ['stop']
                    ))
                },
                null,
                40,
                ['disabled', 'type', 'maxlength', 'step', 'autofocus']
              ),
...
var script$9 = {
  ...
  methods: {
    _onClick($event) {
      ...
      if (!stopPropagation) {
        stopPropagation = /^uni-(checkbox|radio|switch|button)$/i.test(
  ...
  return (
    ...
    createBlock(
      ...
      mergeProps(
        ...
        {
          onClick:
            _cache[1] || (_cache[1] = (...args) => _ctx._onClick(...args))
        }
      ),
      [renderSlot(_ctx.$slots, 'default')],
      16
...
Friction.prototype.s = function(t2) {
  ...
  if (
    (this._y_a > 0 && y < this._endPositionY) ||
    (this._y_a < 0 && y > this._endPositionY)
  ) {
...
Spring.prototype._solve = function(e2, t2) {
  ...
  return {
    x: function(e3) {
      return (
        Math.pow(Math.E, f2 * e3) *
        (v2 * Math.cos(p2 * e3) + g2 * Math.sin(p2 * e3))
      )
    },
    dx: function(e3) {
...
STD.prototype.done = function() {
  ...
  return (
    this._springX.done(e2) &&
    this._springY.done(e2) &&
    this._springScale.done(e2)
  )
}
...
var script$a = {
  ...
  created: function() {
    ...
    this._STD = new STD(
      1,
      (9 * Math.pow(this.dampingNumber, 2)) / 40,
      this.dampingNumber
    )
  ...
  methods: {
    ...
    _setX: function(val) {
      if (this.xMove) {
        if (val + this._scaleOffset.x === this._translateX) {
          ...
          this._animationTo(
            val + this._scaleOffset.x,
            this.ySync + this._scaleOffset.y,
            this._scale
          )
        }
      }
    ...
    _setY: function(val) {
      if (this.yMove) {
        if (val + this._scaleOffset.y === this._translateY) {
          ...
          this._animationTo(
            this.xSync + this._scaleOffset.x,
            val + this._scaleOffset.y,
            this._scale
          )
        }
      }
      ...
      if (!this._isScaling && !this.disabled && this._isTouching) {
        ...
        if (this._firstMoveDirection === null) {
          this._firstMoveDirection =
            Math.abs(event2.detail.dx / event2.detail.dy) > 1
              ? 'htouchmove'
              : 'vtouchmove'
        }
        if (this.xMove) {
        ...
        if (this.yMove) {
          ...
          if (!this.xMove && this._checkCanMove === null) {
            this._checkCanMove =
              Math.abs(event2.detail.dy / event2.detail.dx) < 1
          }
        }
    ...
    __handleTouchEnd: function() {
      ...
      if (!this._isScaling && !this.disabled && this._isTouching) {
        ...
        if (
          ...
          const xv =
            (1e3 *
              (this.__touchInfo.historyX[1] - this.__touchInfo.historyX[0])) /
            (this.__touchInfo.historyT[1] - this.__touchInfo.historyT[0])
          const yv =
            (1e3 *
              (this.__touchInfo.historyY[1] - this.__touchInfo.historyY[0])) /
            (this.__touchInfo.historyT[1] - this.__touchInfo.historyT[0])
    ...
    _updateBoundary: function() {
      ...
      var width =
        this.$parent.width - this.width - this._offset.x - this._scaleOffset.x
      this.minX = Math.min(x, width)
      this.maxX = Math.max(x, width)
      var y = 0 - this._offset.y + this._scaleOffset.y
      var height =
        this.$parent.height - this.height - this._offset.y - this._scaleOffset.y
...
function render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.hoverClass && _ctx.hoverClass !== 'none'
    ? (openBlock(),
      createBlock(
        'uni-navigator',
        mergeProps(
          {
            ...
            onTouchstart:
              _cache[1] ||
              (_cache[1] = (...args) => _ctx._hoverTouchStart(...args)),
            onTouchend:
              _cache[2] ||
              (_cache[2] = (...args) => _ctx._hoverTouchEnd(...args)),
            onTouchcancel:
              _cache[3] ||
              (_cache[3] = (...args) => _ctx._hoverTouchCancel(...args)),
            onClick:
              _cache[4] || (_cache[4] = (...args) => _ctx._onClick(...args))
          },
          _ctx.$attrs
        ),
        [renderSlot(_ctx.$slots, 'default')],
        ...
        mergeProps(
          {
            key: 1,
            onClick:
              _cache[5] || (_cache[5] = (...args) => _ctx._onClick(...args))
          },
          _ctx.$attrs
        ),
        [renderSlot(_ctx.$slots, 'default')],
...
var script$c = {
  ...
  computed: {
    outerBarStyle() {
      return `background-color: ${this.backgroundColor}; height: ${
        this.strokeWidth
      }px;`
    },
    innerBarStyle() {
      let backgroundColor = ''
      if (
        this.color !== VALUES.activeColor &&
        this.activeColor === VALUES.activeColor
      ) {
  ...
  methods: {
    _activeAnimation() {
      if (this.active) {
        this.currentPercent =
          this.activeMode === VALUES.activeMode ? 0 : this.lastPercent
...
function render$c(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    createBlock(
      'uni-progress',
      mergeProps({ class: 'uni-progress' }, _ctx.$attrs),
      [
        createVNode(
          'div',
          {
        ...
        _ctx.showInfo
          ? (openBlock(),
            createBlock(
              'p',
              _hoisted_1$4,
              toDisplayString(_ctx.currentPercent) + '% ',
              1
            ))
          : createCommentVNode('v-if', true)
      ],
      ...
      [
        createVNode('div', _hoisted_1$5, [
          createVNode(
            ...
            {
              class: [
                _ctx.radioChecked ? 'uni-radio-input-checked' : '',
                'uni-radio-input'
              ],
...
function render$g(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    openBlock(), createBlock('uni-rich-text', _ctx.$attrs, [_hoisted_1$6], 16)
  )
}
...
Friction$1.prototype.x = function(e2) {
  ...
  var t2
  t2 =
    e2 === this._dt && this._powDragDt
      ? this._powDragDt
      : (this._powDragDt = Math.pow(this._drag, e2))
  this._dt = e2
...
Spring$1.prototype._solve = function(e2, t2) {
  ...
  return {
    x: function(e3) {
      return (
        Math.pow(Math.E, a2 * e3) *
        (s * Math.cos(d * e3) + l * Math.sin(d * e3))
      )
    },
    dx: function(e3) {
      var t3 = Math.pow(Math.E, a2 * e3)
...
Scroller.prototype.onTouchEnd = function(e2, r, o2) {
  if (
    ...
    if (
      this._enableY &&
      ((Math.abs(r) < this._itemSize && Math.abs(o2.y) < 300) ||
        Math.abs(o2.y) < 150)
    ) {
      this.snap()
      return
    ...
    if (
      this._enableX &&
      ((Math.abs(e2) < this._itemSize && Math.abs(o2.x) < 300) ||
        Math.abs(o2.x) < 150)
    ) {
      this.snap()
      return
  ...
  this._animation = i(
    ...
    () => {
      ...
      if (
        ...
        e3 - this._lastTime > this._lastDelay
      ) {
        this.dispatchScroll()
...
Scroller.prototype.snap = function() {
  ...
  var i2 =
    Math.abs(t2) > this._itemSize / 2
      ? this._position - (e2 - Math.abs(t2))
      : this._position - t2
...
Scroller.prototype.scrollTo = function(e2, t2) {
  ...
  this._element.style.webkitTransition =
    '-webkit-transform ' + (t2 || 0.2) + 's ease-out'
  this.updatePosition()
...
Scroller.prototype.update = function(e2, t2, n) {
  ...
  if (this._enableX) {
    i2 = this._element.childNodes.length
      ? (t2 || this._element.offsetWidth) -
        this._element.parentElement.offsetWidth
      : 0
    this._scrollWidth = t2
  } else {
    i2 = this._element.childNodes.length
      ? (t2 || this._element.offsetHeight) -
        this._element.parentElement.offsetHeight
      : 0
        ...
        if (delta) {
          for (
            touchInfo.maxDy = Math.max(touchInfo.maxDy, Math.abs(delta.y)),
              ...
              touchInfo.historyTime.push(event2.detail.timeStamp);
    ...
    _handleTouchEnd: function(event2) {
      ...
      if (touchInfo.trackingID !== -1) {
        ...
        if (delta) {
          ...
          if (r > 2) {
            for (
              var a2 = touchInfo.historyTime.length - 1,
                s = touchInfo.historyTime[a2],
                l = touchInfo.historyX[a2],
                c = touchInfo.historyY[a2];
              a2 > 0;
...
var script$h = {
  ...
  methods: {
    scrollTo: function(t2, n) {
      ...
      t2 < 0
        ? (t2 = 0)
        : n === 'x' && t2 > i2.scrollWidth - i2.offsetWidth
          ? (t2 = i2.scrollWidth - i2.offsetWidth)
          : n === 'y' &&
...
const _hoisted_5$1 = /* @__PURE__ */ createVNode(
  'path',
  {
    d:
...
const _hoisted_6$1 = /* @__PURE__ */ createVNode(
  'path',
  {
    d: 'M0 0h24v24H0z',
    fill: 'none'
...
const _hoisted_8 = /* @__PURE__ */ createVNode(
  'circle',
  {
    cx: '50',
    cy: '50',
          ...
          [
            createVNode(
              'div',
              {
                ref: 'main',
                style: {
                  'overflow-x': _ctx.scrollX ? 'auto' : 'hidden',
                  'overflow-y': _ctx.scrollY ? 'auto' : 'hidden'
                },
                class: 'uni-scroll-view'
              },
              [
                      ...
                      ? (openBlock(),
                        createBlock(
                          'div',
                          {
                            ...
                            ref: 'refresherinner',
                            style: {
                              'background-color': _ctx.refresherBackground,
                              height: _ctx.refresherHeight + 'px'
                            },
                          ...
                          [
                            _ctx.refresherDefaultStyle !== 'none'
                                    ...
                                    _ctx.refreshState == 'pulling'
                                      ? (openBlock(),
                                        createBlock(
                                          ...
                                          [_hoisted_5$1, _hoisted_6$1],
                                          4
                                        ))
                                      : createCommentVNode('v-if', true),
                                    _ctx.refreshState == 'refreshing'
                                      ? (openBlock(),
                                        createBlock('svg', _hoisted_7, [
                                          _hoisted_8
                                        ]))
                                      : createCommentVNode('v-if', true)
                                  ])
                              ...
                              : createCommentVNode('v-if', true),
                            _ctx.refresherDefaultStyle == 'none'
                              ? renderSlot(_ctx.$slots, 'refresher', { key: 1 })
                              : createCommentVNode('v-if', true)
                          ],
                          4
                        ))
...
var script$i = {
  ...
  methods: {
    _onUserChangedValue(e2) {
      ...
      const value =
        ((e2.x - boxLeft) * (this.max - this.min)) / offsetWidth +
        Number(this.min)
    ...
    _filterValue(e2) {
      return e2 < this.min
        ...
        : e2 > this.max
          ? this.max
          : Math.round((e2 - this.min) / this.step) * this.step +
            Number(this.min)
    },
    _getValueWidth() {
...
function render$i(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    createBlock(
      'uni-slider',
      mergeProps({ ref: 'uni-slider' }, _ctx.$attrs, {
        onClick: _cache[1] || (_cache[1] = (...args) => _ctx._onClick(...args))
      }),
      [
        createVNode('div', _hoisted_1$8, [
          ...
          withDirectives(
            createVNode(
              ...
              toDisplayString(_ctx.sliderValue),
              513
            ),
        ...
        createVNode('div', _hoisted_1$9, [
          withDirectives(
            createVNode(
              ...
              {
                class: [
                  [_ctx.switchChecked ? 'uni-switch-input-checked' : ''],
                  'uni-switch-input'
                ],
                style: {
                  backgroundColor: _ctx.switchChecked ? _ctx.color : '#DFDFDF',
                  borderColor: _ctx.switchChecked ? _ctx.color : '#DFDFDF'
                }
              },
              null,
              6
          ...
          withDirectives(
            createVNode(
              ...
              {
                class: [
                  [_ctx.switchChecked ? 'uni-checkbox-input-checked' : ''],
                  'uni-checkbox-input'
                ],
                style: { color: _ctx.color }
              },
        ...
        createVNode('div', _hoisted_1$a, [
          ...
          createVNode('div', _hoisted_3$2, [
            ...
            createBlock(
              Fragment,
              null,
              renderList(_ctx.valueCompute, (item, index) => {
                return (
                  openBlock(),
                  createBlock(
                    'div',
          ...
          withDirectives(
            createVNode(
              'textarea',
              {
                ...
                class: [
                  { 'uni-textarea-textarea-fix-margin': _ctx.fixMargin },
                  'uni-textarea-textarea'
                ],
                style: { 'overflow-y': _ctx.autoHeight ? 'hidden' : 'auto' },
                onCompositionstart:
                  _cache[2] ||
                  (_cache[2] = (...args) => _ctx._compositionstart(...args)),
                onCompositionend:
                  _cache[3] ||
                  (_cache[3] = (...args) => _ctx._compositionend(...args)),
                onInput:
                  _cache[4] ||
                  (_cache[4] = withModifiers(
                    (...args) => _ctx._input(...args),
                    ['stop']
                  )),
                onFocus:
                  _cache[5] || (_cache[5] = (...args) => _ctx._focus(...args)),
                onBlur:
                  _cache[6] || (_cache[6] = (...args) => _ctx._blur(...args)),
                onTouchstartPassive:
                  _cache[7] ||
                  (_cache[7] = (...args) => _ctx._touchstart(...args))
              },
              null,
              46,
...
export {
  script as Audio,
  script$1 as Canvas,
  script$2 as Checkbox,
  script$3 as CheckboxGroup,
  script$4 as Editor,
  script$5 as Form,
  script$6 as Icon,
  script$7 as Image,
  script$8 as Input,
  script$9 as Label,
  script$a as MovableView,
  script$b as Navigator,
  script$c as Progress,
  script$d as Radio,
  script$e as RadioGroup,
  script$f as ResizeSensor,
  script$g as RichText,
  script$h as ScrollView,
  script$i as Slider,
  script$j as SwiperItem,
  script$k as Switch,
  script$l as Textarea,
  script$m as View,
  passiveOptions,
  supportsPassive$1 as supportsPassive
}
