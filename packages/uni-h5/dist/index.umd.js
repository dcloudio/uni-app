...
var getEmitter = function () {
  ...
  return function getUniEmitter() {
    if (!Emitter) {
      Emitter = new vue__WEBPACK_IMPORTED_MODULE_0___default.a();
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(UniViewJSBridge) {/* harmony import */ var uni_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("85b6");
  ...
  install: function install(Vue) {
    ...
    Vue.mixin({
      beforeCreate: function beforeCreate() {
        ...
        if (Object(uni_helpers__WEBPACK_IMPORTED_MODULE_0__[/* isPage */ "b"])(this)) {
...
var page_component = Object(componentNormalizer["a" /* default */])(
  ...
  pagevue_type_template_id_1388439c_render,
  pagevue_type_template_id_1388439c_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony import */ var uni_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("85b6");
...
function getNodeInfo(el, fields) {
  ...
  if (fields.dataset) {
    info.dataset = Object(uni_helpers__WEBPACK_IMPORTED_MODULE_0__[/* normalizeDataset */ "c"])(el.dataset || {});
  }
...
// CONCATENATED MODULE: ./src/platforms/h5/helpers/todo-api.js
/* harmony default export */ var todo_api = (['saveImageToPhotosAlbum', 'getRecorderManager', 'getBackgroundAudioManager', 'saveVideoToPhotosAlbum', 'createCameraContext', 'createLivePlayerContext', 'saveFile', 'getSavedFileList', 'getSavedFileInfo', 'removeSavedFileInfo', 'getFileInfo', 'onMemoryWarning', 'onGyroscopeChange', 'startGyroscope', 'stopGyroscope', 'scanCode', 'setClipboardData', 'getClipboardData', 'setScreenBrightness', 'getScreenBrightness', 'setKeepScreenOn', 'onUserCaptureScreen', 'addPhoneContact', 'openBluetoothAdapter', 'startBluetoothDevicesDiscovery', 'onBluetoothDeviceFound', 'stopBluetoothDevicesDiscovery', 'onBluetoothAdapterStateChange', 'getConnectedBluetoothDevices', 'getBluetoothDevices', 'getBluetoothAdapterState', 'closeBluetoothAdapter', 'writeBLECharacteristicValue', 'readBLECharacteristicValue', 'onBLEConnectionStateChange', 'onBLECharacteristicValueChange', 'notifyBLECharacteristicValueChange', 'getBLEDeviceServices', 'getBLEDeviceCharacteristics', 'createBLEConnection', 'closeBLEConnection', 'onBeaconServiceChange', 'onBeaconUpdate', 'getBeacons', 'startBeaconDiscovery', 'stopBeaconDiscovery', 'setBackgroundColor', 'setBackgroundTextStyle', 'loadFontFace', 'getProvider', 'login', 'checkSession', 'getUserInfo', 'share', 'onShareAppMessage', 'showShareMenu', 'hideShareMenu', 'requestPayment', 'subscribePush', 'unsubscribePush', 'onPush', 'offPush']);
// EXTERNAL MODULE: ./src/core/service/api/index.js
var service_api = __webpack_require__("d719");

// EXTERNAL MODULE: ./src/platforms/h5/service/api/index.js
var h5_service_api = __webpack_require__("d218");

// EXTERNAL MODULE: ./src/core/service/plugins/app/index.js
var app = __webpack_require__("abbf");

// CONCATENATED MODULE: ./src/core/service/index.js
/* concated harmony reexport getApp */__webpack_require__.d(__webpack_exports__, "getApp", function() { return app["b" /* getApp */]; });
/* concated harmony reexport getCurrentPages */__webpack_require__.d(__webpack_exports__, "getCurrentPages", function() { return app["c" /* getCurrentPages */]; });
...
uni.version = "0.0.1";
todo_api.forEach(function (name) {
  uni[name] = Object(api["c" /* wrapperUnimplemented */])(name);
});
Object.keys(service_api["default"]).forEach(function (name) {
  uni[name] = Object(promise["d" /* promisify */])(name, Object(api["b" /* wrapper */])(name, service_api["default"][name]));
});
Object.keys(h5_service_api["default"]).forEach(function (name) {
  uni[name] = Object(promise["d" /* promisify */])(name, Object(api["b" /* wrapper */])(name, h5_service_api["default"][name]));
});

/* harmony default export */ var service = __webpack_exports__["default"] = (uni);
...
var map = {
	...
	"./create-animation.js": "3e0b",
	"./create-intersection-observer.js": "19ec",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkDeviceWidth", function() { return checkDeviceWidth; });
...
function processTarget(target, detail) {
  var res = {
    ...
    dataset: Object(uni_helpers__WEBPACK_IMPORTED_MODULE_1__[/* normalizeDataset */ "c"])(target.dataset)
  };
