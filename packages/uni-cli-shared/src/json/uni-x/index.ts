...
const __uniRoutes = ${normalizeAppUniRoutes(
    pagesJson
  )}.concat(typeof __uniSystemRoutes !== 'undefined' ? __uniSystemRoutes : []).map(uniRoute=>(uniRoute.meta.route=uniRoute.path,__uniConfig.pages.push(uniRoute.path),uniRoute.path='/'+uniRoute.path,uniRoute));
