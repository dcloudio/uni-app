...
let _dcloudio_compiler_vapor_web = require("@dcloudio/compiler-vapor-web");
_dcloudio_compiler_vapor_web = __toESM(_dcloudio_compiler_vapor_web);
...
const CompilerVaporWebSSR = {
	compile: _dcloudio_compiler_vapor_web.compileSSR,
	parse: _dcloudio_compiler_vapor_web.parse
};
...
function doCompileTemplate({ filename, id, scoped, slotted, inMap, source, ast: inAST, ssr = false, vapor = false, ssrCssVars, isProd = false, compiler, compilerOptions = {}, transformAssetUrls }) {
	...
	const defaultCompiler = vapor ? ssr ? CompilerVaporWebSSR : _dcloudio_compiler_vapor_web : ssr ? _vue_compiler_ssr : _vue_compiler_dom;
