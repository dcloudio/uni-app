...
function createHydrationFunctions(rendererInternals) {
  ...
  - expected on client: ${JSON.stringify(vnode.children)}`
      ...
      default:
        if (shapeFlag & 1) {
          if ((domType !== 1 /* ELEMENT */ || vnode.type.toLowerCase() !== node.tagName.toLowerCase()) && (domType !== 1 /* ELEMENT */ || vnode.type.toLowerCase() !== "uni-" + node.tagName.toLowerCase()) && !isTemplateNode(node)) {
            nextNode = onMismatch();
          } else {
