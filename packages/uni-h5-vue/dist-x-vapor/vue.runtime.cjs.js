...
function setValue(el, value, forceHydrate = false) {
	...
	el._value = value;
	if (isHydrating$1 && !isRecreatedNode(el)) {
		attributeHasMismatch(el, "value", isString(value) ? getClientText(el, value) : value);
...
function renderSlotFallback(boundary, scope) {
	...
	while (boundary) {
		...
		if (localFallback) {
			...
			const content = current.run(() => withSlotBoundary({
				...current,
				getFallback: () => void 0,
				onContentInvalid,
...
function hydrateSlotFragmentContent(frag, render, hasLocalFallback, key, shouldForce) {
	if (frag.sharedFallback || frag.inheritFallback && !hasLocalFallback) {
		...
		if (exposedValid) {
			...
			const anchor = claimUntrackedAnchor(/* @__PURE__ */ createComment((_frag$anchorLabel2 = frag.anchorLabel) !== null && _frag$anchorLabel2 !== void 0 ? _frag$anchorLabel2 : ""));
			frag.anchor = anchor;
			...
			const anchor = frag.anchor = claimUntrackedAnchor(/* @__PURE__ */ createComment((_frag$anchorLabel3 = frag.anchorLabel) !== null && _frag$anchorLabel3 !== void 0 ? _frag$anchorLabel3 : ""));
			const slotEnd = getCurrentSlotEndAnchor();
...
function createSlot(name = "default", rawProps, fallback, flags = 0) {
	...
	if (interopSlotsSource) {
		...
		if (slotFragment) {
			...
			dynamicFragment = new DynamicFragment(132, "slot", false, false, void 0, _insertionAnchor);
...
var SlotFragment = class extends DynamicFragment {
	constructor(flags = 0, adoptAnchor) {
		super(1156, "slot", false, false, void 0, adoptAnchor);
		this.disposed = false;
	...
	return /* @__PURE__ */ defineVaporComponent({
		...
		setup() {
			...
			if (isHydrating$1 && isDynamicFragment(placeholder)) {
				...
				frag = new DynamicFragment(0, "async component");
				if (isHydrating$1) locateHydrationNode();
			}
			let resolvedComp = getResolvedComp();
			if (resolvedComp) {
...
function createIf(condition, b1, b2, flags = 1) {
	...
	if (flags & 16) {
		...
		const dynamicFragment = new DynamicFragment(256, "if", keyed, trackSlotBoundary, trackSlotBoundary ? () => {
...
function createKeyedFragment(key, render, trackSlotBoundary = false) {
	...
	const frag = new DynamicFragment(0, "keyed", true, trackSlotBoundary, trackSlotBoundary ? () => {
...
function createDynamicComponent(getter, rawProps, rawSlots, flags = 0, key) {
	...
	const hydrationCursor = isHydrating$1 ? captureHydrationCursor() : null;
	const frag = new DynamicFragment(0, "dynamic-component", false, slotRoot, slotRoot ? () => {
...
function applyVShow(target, source) {
	...
	const apply = (nodes) => {
		...
		else if (slotRoot || !unresolved && isValidBlock(nodes)) warn("v-show used on component with non-single-element root node and will be ignored.");
	};
	renderEffect(() => {
		value = source();
		apply(target);
...
function applyDirectivesToElement(element, dirs, instance) {
	const hookCounts = instance ? countLifecycleHooks(instance) : null;
	for (const [dir, value, argument, modifiers] of dirs) if (dir) {
		if (!isFunction(dir)) {
			warn(`Received a VDOM object directive` + (isObject(dir) ? ` (hooks: ${Object.keys(dir).join(", ")})` : ``) + " in a Vapor template. Vapor directives must be a function: (el, value, arg, modifiers) => cleanup.");
			continue;
		}
	...
	if (hookCounts) warnLifecycleHooks(instance, hookCounts);
}
...
exports.TransitionPropsValidators = TransitionPropsValidators;
exports.TriggerOpTypes = TriggerOpTypes;
exports.VaporElement = VaporElement;
exports.VaporFragment = VaporFragment;
exports.VaporKeepAlive = VaporKeepAlive;
exports.VaporSlot = VaporSlot;
exports.VaporTeleport = VaporTeleport;
exports.VaporTransition = VaporTransition;
exports.VaporTransitionGroup = VaporTransitionGroup;
exports.VueElement = VueElement;
exports.VueElementBase = VueElementBase;
exports.activate = activate;
exports.applyCheckboxModel = applyCheckboxModel;
exports.applyDynamicModel = applyDynamicModel;
exports.applyRadioModel = applyRadioModel;
exports.applySelectModel = applySelectModel;
exports.applyTextModel = applyTextModel;
exports.applyVShow = applyVShow;
exports.assertNumber = assertNumber;
exports.baseApplyTranslation = baseApplyTranslation;
exports.baseEmit = baseEmit;
exports.baseNormalizePropsOptions = baseNormalizePropsOptions;
exports.baseResolveTransitionHooks = baseResolveTransitionHooks;
exports.callPendingCbs = callPendingCbs;
exports.callWithAsyncErrorHandling = callWithAsyncErrorHandling;
exports.callWithErrorHandling = callWithErrorHandling;
exports.camelize = camelize;
exports.capitalize = capitalize;
exports.checkTransitionMode = checkTransitionMode;
exports.child = child;
...
exports.createAssetComponent = createAssetComponent;
exports.createAsyncComponentContext = createAsyncComponentContext;
exports.createBlock = createBlock;
exports.createCanSetSetupRefChecker = createCanSetSetupRefChecker;
...
exports.createKeyedFragment = createKeyedFragment;
...
exports.createTemplateRefSetter = createTemplateRefSetter;
exports.createTextNode = createTextNode;
exports.createTextVNode = createTextVNode;
exports.createVNode = createVNode;
exports.createVaporApp = createVaporApp;
exports.createVaporSSRApp = createVaporSSRApp;
Object.defineProperty(exports, "currentInstance", {
	enumerable: true,
	get: function() {
...
exports.defaultPropGetter = defaultPropGetter;
...
exports.defineVaporAsyncComponent = defineVaporAsyncComponent;
exports.defineVaporComponent = defineVaporComponent;
exports.defineVaporCustomElement = defineVaporCustomElement;
exports.defineVaporSSRCustomElement = defineVaporSSRCustomElement;
...
exports.ensureHydrationRenderer = ensureHydrationRenderer;
exports.ensureRenderer = ensureRenderer;
exports.ensureValidVNode = ensureValidVNode;
exports.ensureVaporSlotFallback = ensureVaporSlotFallback;
exports.expose = expose;
exports.extend = extend;
exports.filterModelListeners = filterModelListeners;
exports.flushOnAppMount = flushOnAppMount;
exports.forceReflow = forceReflow;
exports.getAttributeMismatch = getAttributeMismatch;
...
exports.getFunctionalFallthrough = getFunctionalFallthrough;
exports.getInheritedScopeIds = getInheritedScopeIds;
exports.getRestElement = getRestElement;
exports.getTransitionRawChildren = getTransitionRawChildren;
exports.guardReactiveProps = guardReactiveProps;
exports.h = h;
exports.handleError = handleError;
exports.handleMovedChildren = handleMovedChildren;
exports.hasCSSTransform = hasCSSTransform;
...
exports.invalidateMount = invalidateMount;
exports.invokeDirectiveHook = invokeDirectiveHook;
exports.invokeKeepAliveHooks = invokeKeepAliveHooks;
exports.isAsyncWrapper = isAsyncWrapper;
exports.isEmitListener = isEmitListener;
exports.isFragment = isFragment;
exports.isFunctionalFallthroughKey = isFunctionalFallthroughKey;
Object.defineProperty(exports, "isHydrating", {
	enumerable: true,
	get: function() {
		return isHydrating;
	}
});
Object.defineProperty(exports, "isHydratingEnabled", {
	enumerable: true,
	get: function() {
		return isHydratingEnabled;
	}
});
Object.defineProperty(exports, "isInSSRComponentSetup", {
	enumerable: true,
	get: function() {
...
exports.isMismatchAllowed = isMismatchAllowed;
...
exports.isTeleportDeferred = isTeleportDeferred;
exports.isTeleportDisabled = isTeleportDisabled;
exports.isTemplateNode = isTemplateNode;
exports.isTemplateRefKey = isTemplateRefKey;
exports.isVNode = isVNode;
exports.isValidHtmlOrSvgAttribute = isValidHtmlOrSvgAttribute;
exports.isVaporComponent = isVaporComponent;
exports.knownTemplateRefs = knownTemplateRefs;
exports.leaveCbKey = leaveCbKey;
exports.logError = logError;
exports.logMismatchError = logMismatchError;
exports.markAsyncBoundary = markAsyncBoundary;
...
exports.performAsyncHydrate = performAsyncHydrate;
exports.performTransitionEnter = performTransitionEnter;
exports.performTransitionLeave = performTransitionLeave;
exports.popScopeId = popScopeId;
exports.popWarningContext = popWarningContext;
exports.prepareTransitionLeave = prepareTransitionLeave;
exports.prepareTransitionSwitch = prepareTransitionSwitch;
...
exports.rawVaporSlotKey = rawVaporSlotKey;
...
exports.resetKeepAliveHookState = resetKeepAliveHookState;
...
exports.resolveTeleportTarget = resolveTarget;
exports.resolveTransitionChild = resolveTransitionChild;
exports.resolveTransitionHooks = resolveTransitionHooks;
exports.resolveTransitionProps = resolveTransitionProps;
exports.restoreCurrentInstance = restoreCurrentInstance;
exports.setAttr = setAttr;
exports.setBlockKey = setBlockKey;
...
exports.setImageDynamicEvents = setImageDynamicEvents;
exports.setImageDynamicProps = setImageDynamicProps;
exports.setImageMode = setImageMode;
exports.setImageSrc = setImageSrc;
exports.setInsertionState = setInsertionState;
exports.setIsHydratingEnabled = setIsHydratingEnabled;
exports.setProp = setProp;
exports.setRealPathResolver = setRealPathResolver;
exports.setRef = setRef;
exports.setStaticTemplateRef = setStaticTemplateRef;
exports.setStyle = setStyle;
exports.setTemplateRefBinding = setTemplateRefBinding;
exports.setText = setText;
exports.setTransitionHooks = setTransitionHooks;
exports.setValue = setValue;
exports.setVarsOnNode = setVarsOnNode;
exports.setViewDynamicProps = setViewDynamicProps;
exports.shallowReactive = shallowReactive;
exports.shallowReadonly = shallowReadonly;
exports.shallowRef = shallowRef;
exports.shouldSetAsProp = shouldSetAsProp;
exports.shouldSetAsPropForVueCE = shouldSetAsPropForVueCE;
exports.shouldUpdateComponent = shouldUpdateComponent;
Object.defineProperty(exports, "simpleSetCurrentInstance", {
	enumerable: true,
	get: function() {
		return simpleSetCurrentInstance;
	}
});
...
exports.unsafeToTrustedHTML = unsafeToTrustedHTML;
exports.useAsyncComponentState = useAsyncComponentState;
...
exports.useVaporCssVars = useVaporCssVars;
exports.vModelCheckbox = vModelCheckbox;
exports.vModelCheckboxInit = vModelCheckboxInit;
exports.vModelCheckboxUpdate = vModelCheckboxUpdate;
exports.vModelDynamic = vModelDynamic;
exports.vModelGetValue = getValue;
exports.vModelRadio = vModelRadio;
exports.vModelSelect = vModelSelect;
exports.vModelSelectInit = vModelSelectInit;
exports.vModelSetSelected = vModelSetSelected;
exports.vModelText = vModelText;
exports.vModelTextInit = vModelTextInit;
exports.vModelTextUpdate = vModelTextUpdate;
exports.vShow = vShow;
exports.vShowHidden = vShowHidden;
exports.vShowOriginalDisplay = vShowOriginalDisplay;
exports.validateComponentName = validateComponentName;
exports.validateProps = validateProps;
exports.vaporInteropPlugin = vaporInteropPlugin;
exports.vdomSlotFallbackKey = vdomSlotFallbackKey;
exports.version = version;
exports.vtcKey = vtcKey;
exports.warn = warn;
exports.warnExtraneousAttributes = warnExtraneousAttributes;
exports.warnPropMismatch = warnPropMismatch;
exports.watch = watch;
...
exports.withImageEventDetail = withImageEventDetail;
exports.withKeys = withKeys;
exports.withMemo = withMemo;
exports.withModifiers = withModifiers;
exports.withOnce = withOnce;
exports.withScopeId = withScopeId;
exports.withVaporDirectives = withVaporDirectives;
exports.withVaporKeys = withVaporKeys;
exports.withVaporModifiers = withVaporModifiers;
