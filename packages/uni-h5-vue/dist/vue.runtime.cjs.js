...
const ErrorTypeStrings = {
    ...
    ["ba" /* LifecycleHooks.BEFORE_ACTIVATE */]: 'beforeActivate hook',
    ["a" /* LifecycleHooks.ACTIVATED */]: 'activated hook',
    ["bda" /* LifecycleHooks.BEFORE_DEACTIVATE */]: 'beforeDeactivate hook',
...
function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
    ...
    const refValue = vnode.shapeFlag & 4 /* ShapeFlags.STATEFUL_COMPONENT */ &&
        (!false ) // fixed by xxxxxx 非 x 项目或者非内置组件
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    createElement: hostCreateElement, createText: hostCreateText, createComment: hostCreateComment, setText: hostSetText, setElementText: hostSetElementText, parentNode: hostParentNode, nextSibling: hostNextSibling, setScopeId: hostSetScopeId = shared.NOOP, insertStaticContent: hostInsertStaticContent } = options;
...
const computed = ((getterOrOptions, debugOptions) => {
    // @ts-ignore
    return computed$1(getterOrOptions, debugOptions, exports.isInSSRComponentSetup);
});
...
const TransitionPropsValidators = (Transition.props =
    /*#__PURE__*/ shared.extend({}, BaseTransitionPropsValidators, DOMTransitionPropsValidators));
/**
