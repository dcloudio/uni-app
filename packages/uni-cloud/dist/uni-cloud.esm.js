				...
				_doProcessBlock: function(e, t) {
					...
					E = u(E, O, U, b, i, 7, a[0]), b = u(b, E, O, U, c, 12, a[1]), U =
						...
						b = l(b, E, O, U, g, 11, a[37]), U = l(U, b, E, O, _, 16, a[
							38]), O = l(O, U, b, E, S, 23, a[39]), E = l(E, O, U, b, A,
							4,
						...
						U = d(U, b, E, O, P, 15, a[50]), O = d(O, U, b, E, m, 21, a[
							51]), E = d(E, O, U, b, k, 6, a[52]), b = d(b, E, O, U, p,
							10,
						...
						b = d(b, E, O, U, T, 10, a[61]), U = d(U, b, E, O, f, 15, a[
							62]), O = d(O, U, b, E, w, 21, a[63]), o[0] = o[0] + E | 0,
						o[
...
(() => {
	{
		let e = {};
		if (1 === process.env.UNI_CLOUD_PROVIDER.length) e = process.env.UNI_CLOUD_PROVIDER[0], We = We.init(e);
		else {
			const e = ["auth", "callFunction", "uploadFile", "deleteFile", "getTempFileURL", "downloadFile",
					"database", "getCurrentUSerInfo"
				],
				t = process.env.UNI_CLOUD_PROVIDER.length > 0 ? "应用有多个服务空间，请通过uniCloud.init方法指定要使用的服务空间" :
