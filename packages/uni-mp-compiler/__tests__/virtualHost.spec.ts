...
describe('virtualHost', () => {
  ...
  return { a: _n(_ctx.foo), b: _pvhc(_ctx.$scope.data.virtualHostClass), c: _gei(_ctx, '') }
    ...
    assert(
      ...
      `(_ctx, _cache) => { "raw js"
  const __returned__ = { a: _gei(_ctx, ''), b: \`\${_ctx.u_s_b_h}px\`, c: _p({ id: _gei(_ctx, ''), style: { '--status-bar-height': \`\${_ctx.u_s_b_h}px\` } }), d: _pvhc(_ctx.$scope.data.virtualHostClass) }
  return __returned__
}`,
      optionsX
    )
    ...
    assert(
      ...
      `(_ctx, _cache) => { "raw js"
  const __returned__ = { a: _gei(_ctx, ''), b: \`\${_ctx.u_s_b_h}px\`, c: _p({ id: _gei(_ctx, ''), class: 'foo', style: { '--status-bar-height': \`\${_ctx.u_s_b_h}px\` } }), d: _pvhc(_ctx.$scope.data.virtualHostClass) }
  return __returned__
}`,
      optionsX
    )
    ...
    assert(
      ...
      `(_ctx, _cache) => { "raw js"
  const __returned__ = { a: _gei(_ctx, ''), b: _n(_ctx.foo), c: _pvhc(_ctx.$scope.data.virtualHostClass), d: \`\${_ctx.u_s_b_h}px\`, e: _p({ id: _gei(_ctx, ''), class: _ctx.foo, style: { '--status-bar-height': \`\${_ctx.u_s_b_h}px\` } }) }
  return __returned__
}`,
      optionsX
    )
