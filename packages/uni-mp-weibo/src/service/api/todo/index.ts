...
export const getUserInfo = defineAsyncApi<typeof uni.getUserInfo>(
  API_GET_USER_INFO,
  (args, { resolve, reject }) => {
    resolve()
  }
)
const API_CHECK_SESSION = 'checkSession'
export const checkSession = defineAsyncApi<typeof uni.checkSession>(
  API_CHECK_SESSION,
  (args, { resolve, reject }) => {
    resolve()
  }
