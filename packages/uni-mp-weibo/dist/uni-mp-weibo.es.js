...
const onKeyboardHeightChange = /* @__PURE__ */ defineAsyncApi(
...
const offKeyboardHeightChange = /* @__PURE__ */ defineAsyncApi(
...
const getUserInfo = /* @__PURE__ */ defineAsyncApi(
  API_GET_USER_INFO,
  (args, { resolve, reject }) => {
    resolve();
  }
...
const checkSession = /* @__PURE__ */ defineAsyncApi(
  API_CHECK_SESSION,
  (args, { resolve, reject }) => {
    resolve();
  }
