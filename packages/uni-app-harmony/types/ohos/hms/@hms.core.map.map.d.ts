...
declare namespace map {
    ...
    class MapComponentController {
         ...
         * @returns { Promise<MapCircle> } Return the marker object.
         * @throws { BusinessError } 401 - Invalid input parameter.
         * @throws { BusinessError } 1002601001 - The object to be operated does not exist.
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
    ...
    interface MapPolyline extends BaseOverlay {
         ...
         * Abnormal values are processed as no response.
         *
         * @param { boolean } geodesic - Indicates whether to enable the gradient color if there are multiple colors.
         * @returns { void }
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
    ...
    interface ImageOverlay extends BaseOverlay {
         ...
         * Set the image
         *
         * @param { ResourceStr | image.PixelMap } icon - Indicates the image.
         * @return { Promise<void> }
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
         ...
         * Set the position
         *
         * @param { mapCommon.LatLng } bounds - Indicates the position.
         * @return { void }
         * @syscap SystemCapability.Map.Core
         * @stagemodelonly
         * @atomicservice
