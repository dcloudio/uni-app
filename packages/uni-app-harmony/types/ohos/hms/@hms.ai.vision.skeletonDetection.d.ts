...
declare namespace skeletonDetection {
    ...
    class SkeletonDetector extends visionBase.Analyzer {
         ...
         * @returns { Promise<SkeletonDetector> } - The engine of object detection.
         ...
         * @param { VisionBaseRequest } request - The skeleton detection request, contains information of the image.
