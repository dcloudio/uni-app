...
declare namespace rcp {
    ...
    export interface WriteFile {
         ...
         * @returns { Promise<number> } Return the number you write or noting if you do not care.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
    ...
    export interface ReadFile {
         ...
         * @returns { Promise<number> } Return the number you read.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
    ...
    export interface WriteStream {
         ...
         * Write to a stream.
         * @param { ArrayBuffer } buffer - Buffer you want to write.
         * @returns { Promise<void | number> } Return the number you write or nothing if you do not care.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
        write(buffer: ArrayBuffer): Promise<void | number>;
    ...
    export interface ReadStream {
         ...
         * Read from a stream.
         * @param { ArrayBuffer } buffer - Where to set the result.
         * @returns { Promise<void | number> } Return the number you read.
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 5.0.0(12)
         */
        read(buffer: ArrayBuffer): Promise<number>;
     ...
     * @since 5.0.0(12)
     */
    export type ResponseBodyDestination = 'array-buffer' | IncomingDataCallback | DownloadToFile | DownloadToStream;
    /**
     ...
     * @since 5.0.0(12)
     */
    export type RequestContent = RawDataContent | Form | MultipartForm | GetDataCallback | UploadFromFile | UploadFromStream;
    /**
    ...
    export interface Session {
         ...
         * @returns { Promise<Response> } The promise returned by the function.
         * @throws Check {@link Session.fetch}
         * @syscap SystemCapability.Collaboration.RemoteCommunication
         * @since 4.1.0(11)
         */
        /**
