...
declare namespace liveViewManager {
    ...
    export interface ExtensionData {
        /**
         * the text of extend area content of liveView.
         *
         * @type { ?string }
         * @syscap SystemCapability.LiveView.LiveViewService
         * @StageModelOnly
        ...
        /**
         * WantAgent instance to which the extend area will be clicked.
         *
         * @type { ?WantAgent }
         * @syscap SystemCapability.LiveView.LiveViewService
         * @StageModelOnly
    ...
    export interface ProgressCapsule extends CapsuleData {
        ...
        progress?: number;
        /**
         * Specifies whether the progress is displayed as a percentage or in other forms.
         *
         * @type { ?boolean }
         * @syscap SystemCapability.LiveView.LiveViewService
         * @StageModelOnly
    ...
    export interface ProgressLayout extends LayoutData {
        ...
        backgroundColor?: string;
        /**
         * display type of indicator small icon,
    ...
    export interface FlightLayout extends LayoutData {
        ...
        /**
         * Indicates whether to display the split line above the FlightLayout.
         *
         * @type { ?boolean }
         * @syscap SystemCapability.LiveView.LiveViewService
         * @StageModelOnly
    ...
    export interface ScoreLayout extends LayoutData {
        ...
        /**
         * Indicates whether to display the split line above the ScoreLayout.
         *
         * @type { ?boolean }
         * @syscap SystemCapability.LiveView.LiveViewService
         * @StageModelOnly
