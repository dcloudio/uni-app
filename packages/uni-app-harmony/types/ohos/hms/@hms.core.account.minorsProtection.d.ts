...
declare namespace minorsProtection {
    ...
    */
     ...
     * @throws { BusinessError } 401 - Parameter error. Possible causes: 1. Missing context parameter. 2. Incorrect context parameter type.
     * @throws { BusinessError } 1001502009 - Internal error.
    ...
    */
     ...
     * @throws { BusinessError } 1009900007 - Unsupported account.
     * @syscap SystemCapability.AuthenticationServices.HuaweiID.MinorsProtection
     * @stagemodelonly
     * @atomicservice
     * @since 5.0.0(12)
