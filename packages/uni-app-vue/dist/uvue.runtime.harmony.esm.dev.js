...
function isBlock(val) {
  return val instanceof Node || isArray$1(val) || isVaporComponent(val) || isFragment(val);
}
...
var createFor = function (src, renderItem, getKey) {
  ...
  var newBlocks;
  var parent;
  var parentAnchor = createComment("for");
