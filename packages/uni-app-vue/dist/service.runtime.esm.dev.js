...
function vueFactory(exports) {
  (function (reactivity, shared) {
    ...
    function normalizeEventType(type, options) {
      ...
      return "on".concat(shared.capitalize(shared.camelize(type)));
    }
    ...
    class UniNode extends UniEventTarget {
      ...
      cloneNode(deep) {
        var cloned = shared.extend(Object.create(Object.getPrototypeOf(this)), this);
        var {
          attributes
        } = cloned;
    ...
    function warn(msg) {
      ...
      if (appWarnHandler) {
        ...
        /* APP_WARN_HANDLER */
        , [msg + args.join(''), instance && instance.proxy, trace.map(_ref2 => {
          var {
            vnode
          } = _ref2;
    ...
    function doWatch(source, cb) {
      ...
      var effect = new reactivity.ReactiveEffect(getter, scheduler);
      {
      ...
      /* FULL_PROPS */
        ...
        if (attrs !== rawCurrentProps) {
          for (var _key12 in attrs) {
            if (!rawProps || !hasOwn(rawProps, _key12) && !false) {
              delete attrs[_key12];
              hasAttrsChanged = true;
            }
          }
    ...
    */
    ...
    function baseCreateRenderer(options, createHydrationFns) {
      ...
      var moveStaticNode = (_ref11, container, nextSibling) => {
        var {
          el,
          anchor
        } = _ref11;
      ...
      var setupRenderEffect = (instance, initialVNode, container, anchor, parentSuspense, isSVG, optimized) => {
        ...
        var effect = instance.effect = new reactivity.ReactiveEffect(componentUpdateFn, () => queueJob(instance.update), instance.scope // track it in component's effect scope
        );
    ...
    var normalizeRef = _ref18 => {
      var {
        ref,
        ref_key,
        ref_for
      } = _ref18;
      return ref != null ? isString(ref) || reactivity.isRef(ref) || isFunction(ref) ? {
    ...
    function _createVNode(type) {
      ...
      if (props) {
        ...
        if (isObject(style)) {
          ...
          // mutated
          if (reactivity.isProxy(style) && !isArray(style)) {
            style = extend({}, style);
          }
    ...
    function guardReactiveProps(props) {
      if (!props) return null;
      return reactivity.isProxy(props) || InternalObjectKey in props ? extend({}, props) : props;
    }
      ...
      var formatter = {
        header(obj) {
          ...
          if (obj.__isVue) {
            ...
            return ['div', {}, ['span', vueStyle, isShallow(obj) ? 'ShallowReactive' : 'Reactive'], '<', formatValue(obj), ">".concat(reactivity.isReadonly(obj) ? " (readonly)" : "")];
      ...
      if (!next) {
        ...
        if (isPrevObj) {
          ...
          for (var _key19 in next) {
            var value = next[_key19];

            if (value !== prev[_key19]) {
              batchedStyles[_key19] = value;
            }
          }
        } else {
    ...
    var withModifiers = (fn, modifiers) => {
      ...
      var wrapper = function (event) {
        ...
        for (var _len10 = arguments.length, args = new Array(_len10 > 1 ? _len10 - 1 : 0), _key21 = 1; _key21 < _len10; _key21++) {
    ...
    var Vue = {
      ...
      EffectScope: reactivity.EffectScope,
      ReactiveEffect: reactivity.ReactiveEffect,
      customRef: reactivity.customRef,
      effect: reactivity.effect,
      effectScope: reactivity.effectScope,
      getCurrentScope: reactivity.getCurrentScope,
      isProxy: reactivity.isProxy,
      isReactive: reactivity.isReactive,
      isReadonly: reactivity.isReadonly,
      isRef: reactivity.isRef,
      isShallow: reactivity.isShallow,
      markRaw: reactivity.markRaw,
      onScopeDispose: reactivity.onScopeDispose,
      proxyRefs: reactivity.proxyRefs,
      reactive: reactivity.reactive,
      readonly: reactivity.readonly,
      ref: reactivity.ref,
    ...
    exports.Vue = Vue;
  })(exports.VueReactivity, exports.VueShared);
}
