    ...
    (function () {
      ...
      for (var _key14 in next) {
        ...
        if (!isSame(prevValue, value)) {
          var _key = _key14.startsWith("--") ? _key14 : camelize(_key14);
