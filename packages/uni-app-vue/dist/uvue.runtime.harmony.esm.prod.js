  ...
  if (isPrevObj) {
    (function () {
      ...
      for (var _key18 in next) {
        var value = next[_key18];
        var prevValue = prev[_key18];
        if (!isSame(prevValue, value)) {
          var _key = _key18.startsWith("--") ? _key18 : camelize(_key18);
