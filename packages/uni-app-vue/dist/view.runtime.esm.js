import { extend, isSymbol, isObject, toRawType, def, hasChanged, isArray, isFunction, NOOP, getGlobalThis, remove, toHandlerKey, isString, camelize, capitalize, normalizeClass, normalizeStyle, isOn, NO, isPromise, EMPTY_OBJ, toNumber, hyphenate, invokeArrayFns, looseIndexOf, isSet, looseEqual, isHTMLTag, isSVGTag, isReservedProp, EMPTY_ARR, hasOwn, makeMap, isMap, isPlainObject, isModelListener, isSpecialBooleanAttr, includeBooleanAttr, isIntegerKey, isGloballyWhitelisted } from '@vue/shared';
