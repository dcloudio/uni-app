import { isSymbol, isObject, hasOwn, def, hasChanged, isFunction, isArray as isArray$1, extend, toRawType, EMPTY_OBJ, isSet, isMap, isPlainObject, isIntegerKey, NOOP, makeMap, isPromise, getGlobalThis, isString, remove as remove$1, camelize, capitalize, toHandlerKey, hyphenate, isReservedProp, looseToNumber, isOn, isBuiltInTag, parseStringStyle, canSetValueDirectly, invokeArrayFns, isRegExp, toNumber, EMPTY_ARR, toDisplayString, NO, isModelListener, getSequence, normalizeStyle as normalizeStyle$2, isGloballyAllowed, YES } from '@vue/shared';
