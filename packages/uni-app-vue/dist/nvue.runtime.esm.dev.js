...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
  ...
  !isInHmrContext(instance) && (optimized || patchFlag > 0) && !(patchFlag & 16)) {
    ...
    var kebabKey;
    for (var _key0 in rawCurrentProps) {
      if (!rawProps ||
      // for camelCase
      !hasOwn(rawProps, _key0) && (
      // it's possible the original props was passed in as kebab-case
      // and converted to camelCase (#955)
      (kebabKey = hyphenate(_key0)) === _key0 || !hasOwn(rawProps, kebabKey))) {
        if (options) {
          if (rawPrevProps && (
          // for camelCase
          rawPrevProps[_key0] !== void 0 ||
          // for kebab-case
          rawPrevProps[kebabKey] !== void 0)) {
            props[_key0] = resolvePropValue(options, rawCurrentProps, _key0, void 0, instance, true);
          }
        } else {
          delete props[_key0];
        }
    ...
    if (attrs !== rawCurrentProps) {
      for (var _key1 in attrs) {
        if (!rawProps || !hasOwn(rawProps, _key1) && true) {
          delete attrs[_key1];
          hasAttrsChanged = true;
        }
      }
  ...
  var patchProps = (el, vnode, oldProps, newProps, parentComponent, parentSuspense, namespace) => {
    if (oldProps !== newProps) {
      ...
      for (var _key12 in newProps) {
        ...
        if (next !== prev && _key12 !== "value" || hostForcePatchProp && hostForcePatchProp(el, _key12)) {
          hostPatchProp(el, _key12, prev, next, namespace, vnode.children, parentComponent, parentSuspense, unmountChildren,
          // fixed by xxxxxx
          vnode.hostInstance);
        }
      }
...
var createVNodeWithArgsTransform = function () {
  for (var _len7 = arguments.length, args = new Array(_len7), _key13 = 0; _key13 < _len7; _key13++) {
    ...
    return Object.freeze({
      ...
      get emit() {
        return function (event) {
          for (var _len8 = arguments.length, args = new Array(_len8 > 1 ? _len8 - 1 : 0), _key14 = 1; _key14 < _len8; _key14++) {
