  ...
  if (isPrevObj) {
    (function () {
      ...
      for (var _key13 in next) {
        var _value2 = next[_key13];
        // const prevValue = prev[key]
        // if (!isSame(prevValue, value))
        {
          parseStyleDecl(camelize(_key13), _value2).forEach((value, key) => {
            batchedStyles.set(key, value);
