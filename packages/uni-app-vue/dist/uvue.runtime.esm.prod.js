import { extend, isSymbol, isObject, hasOwn, def, hasChanged, isFunction, isArray as isArray$1, toRawType, EMPTY_OBJ, NOOP, remove as remove$1, isSet, isMap, isPlainObject, isIntegerKey, makeMap, hyphenate, capitalize, isPromise, getGlobalThis, isString, camelize, toHandlerKey, isReservedProp, looseToNumber, isOn, isBuiltInTag, normalizeClass as normalizeClass$1, normalizeStyle as normalizeStyle$2, parseStringStyle, canSetValueDirectly, invokeArrayFns, isRegExp, toNumber, EMPTY_ARR, toDisplayString, NO, getSequence, isModelListener, isGloballyAllowed, YES } from '@vue/shared';
