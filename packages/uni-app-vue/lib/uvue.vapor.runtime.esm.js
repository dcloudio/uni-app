...
* @license MIT
**/
import { isString, isFunction, EMPTY_OBJ, isPromise, isArray, getGlobalThis, extend, isBuiltInDirective, hasOwn, remove as remove$1, def, isOn, isReservedProp, normalizeClass, stringifyStyle, normalizeStyle as normalizeStyle$1, isKnownSvgAttr, isBooleanAttr, isKnownHtmlAttr, includeBooleanAttr, isRenderableAttrValue, normalizeCssVarValue, getEscapedCssVarName, isObject, isRegExp, invokeArrayFns, toHandlerKey, capitalize, camelize, isSymbol, NOOP, isGloballyAllowed, NO, hyphenate, makeMap, toRawType, EMPTY_ARR, getSequence, hasChanged, looseToNumber, isModelListener, toNumber, isBuiltInTag, parseStringStyle, canSetValueDirectly, toDisplayString, YES } from '@vue/shared';
export { camelize, capitalize, hyphenate, toDisplayString, toHandlerKey } from '@vue/shared';
import { setActiveSub, isRef, toRaw, traverse, shallowRef, readonly, isReactive, ref, isShallow, isReadonly, shallowReadArray, toReadonly, toReactive, track, shallowReadonly, reactive, shallowReactive, trigger, ReactiveEffect, setCurrentScope, WatcherEffect, customRef, isProxy, proxyRefs, markRaw, EffectScope, computed as computed$1, onEffectCleanup, onScopeDispose, watch as watch$1 } from '@vue/reactivity';
...
function createMountPage(appContext) {
  return function mountPage(pageComponent, pageProps, pageContainer) {
    if (pageComponent.__vapor) {
      const rawProps = Object.keys(pageProps).reduce(
        (acc, key) => {
