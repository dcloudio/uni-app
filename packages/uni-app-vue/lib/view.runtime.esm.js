import { extend, isArray, isMap, isIntegerKey, isSymbol, hasOwn, isObject as isObject$1, hasChanged, makeMap, capitalize, toRawType, def, isFunction as isFunction$1, NOOP, EMPTY_OBJ, toHandlerKey, toNumber, hyphenate, camelize, isOn, isModelListener, remove, isString, invokeArrayFns, isPromise as isPromise$1, isReservedProp, EMPTY_ARR, NO, getGlobalThis, normalizeClass, normalizeStyle, isGloballyWhitelisted, isSet, isPlainObject, isSpecialBooleanAttr, includeBooleanAttr, looseIndexOf, looseEqual, isHTMLTag, isSVGTag } from '@vue/shared';
