...
const vModelText = {
    ...
    mounted(el, _binding, _vnode, _prevVNode) {
        var _a;
        el.setAnyAttribute('value', (_a = _binding.value) !== null && _a !== void 0 ? _a : '');
    },
