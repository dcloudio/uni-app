...
declare namespace ts {
  ...
  function parseNodeWithCustomTransformer<T extends Node>(
    node: T,
    parser: CustomParsers,
    options: ParseTransformNodesOptions
  ): Node
  ...
  type ParseNodeTransformerFactory<T extends Node> = (
    context: ParseNodeTransformationContext
  ) => (node: T) => Node | undefined
  type ParseSourceFileTransformerFactory = (
    context: ParseSourceFileTransformationContext
  ) => ParseTransformer<SourceFile>
  ...
  interface ParseSourceFileTransformationContext
    extends ParseTransformNodesOptions,
  ...
  function printUTSSourceFile(
    ...
    beginPrint: () => EmitTextWriter,
    endPrint: () => string,
    printerOptions: PrinterOptions,
    mapOptions?: UTSSourceMapOptions
  ): {
    code: string
    map: string | undefined
  }
  type UTSEmitHost = Pick<
    EmitHost,
    'getCanonicalFileName' | 'getCurrentDirectory'
  >
