...
实现操作页面导航栏相关功能。  
API规范文档：
[uni.setNavigationBarColor](https://doc.dcloud.net.cn/uni-app-x/api/set-navigation-bar-color.html)  
[uni.setNavigationBarTitle](https://doc.dcloud.net.cn/uni-app-x/api/set-navigation-bar-title.html)  
[uni.showNavigationBarLoading](https://doc.dcloud.net.cn/uni-app-x/api/navigator-bar-loading.html)  
