		...
		<view class="page-body">
			...
			<view class="page-section">
				...
				<view class="page-section-spacing">
					<view class="uni-flex uni-row" style="margin-top: 60px;">
			...
			<view class="page-section">
				...
				<view class="uni-flex uni-column" style="margin-top: 60px;">
			...
			<view class="page-section">
				...
				<view class="text" style="width: 300px;">纵向布局-固定宽度</view>
				...
				<view class="uni-flex uni-row">
					<view class="text" style="width: 200px;">固定宽度</view>
				...
				<view class="uni-flex uni-row" style="flex-wrap: wrap;">
					<view class="text" style="width: 280px;">一行显示不全,wrap折行</view>
					<view class="text" style="width: 280px;">一行显示不全,wrap折行</view>
					<view class="text" style="width: 280px;">一行显示不全,wrap折行</view>
				</view>
				<view class="uni-flex uni-row">
					...
					<view class="text" style="flex: 1;height: 200px;display: flex; justify-content: center;align-items: center;">
						<text>垂直居中</text>
					</view>
			...
			<view class="page-section">
				...
				<view class="uni-flex uni-row">
					<view class="text" style="width: 200px;height: 220px;display: flex; justify-content: center;align-items: center;">
						<image src="../../../static/plus.png" style="width: 150px;height: 150px;"></image>
					</view>
