...
| user-select | boolean | false | Web: 5.25; 微信小程序: 4.41; Android(VDOM): 3.9; Android(Vapor): 5.25; iOS(VDOM): 4.11; iOS(Vapor): 5.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.25 | 文本是否可选，该属性会使节点显示为 block |
