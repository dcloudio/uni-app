...
| user-select | boolean | false | Web: 5.24; 微信小程序: 4.41; 支付宝小程序: x; Android(VDOM): 3.9; Android(Vapor): 5.24; iOS(VDOM): 4.11; iOS(Vapor): 5.24; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.24 | 文本是否可选，该属性会使节点显示为 block |
