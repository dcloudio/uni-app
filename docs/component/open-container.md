...
| 名称 | 类型 | 兼容性 | 描述 |
| :- | :- |  :-: | :- |
| closed-color | string | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(string)*<br/>初始容器背景色 |
| closed-elevation | number | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(number)*<br/>初始容器影深大小 |
| closed-border-radius | number | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(number)*<br/>初始容器圆角大小 |
| middle-color | string | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(string)*<br/>`fadeThrough` 模式下的过渡背景色 |
| open-color | string | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(string)*<br/>打开状态下容器背景色 |
| open-elevation | number | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(number)*<br/>打开状态下容器影深大小 |
| open-border-radius | number | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(number)*<br/>打开状态下容器圆角大小 |
| transition-duration | number | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(number)*<br/>动画时长 |
| transition-type | string | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | *(string)*<br/>动画类型 |

#### transition-type 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| fade | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | 将传入元素淡入传出元素之上 |
| fadeThrough | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | 首先淡出传出元素，并在传出元素完全淡出后开始淡入传入元素 |
