...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| disabled | boolean | false | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 是否禁用 |
| mode | String as PropType\<Mode> | "selector" | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 选择器类型 |
| range | string[\] | [\] | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | mode为 selector 或 multiSelector 时，range 有效 |
| range-key | string |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 当 range 是一个 Object Array 时，通过 range-key 来指定 Object 中 key 的值作为选择器显示内容 |
| value | string \| number \| number[\] |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 表示选择了 range 中的第几个（下标从 0 开始） |
| start | string |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 表示有效时间范围的开始 |
| end | string |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 表示有效时间范围的结束 |
| fields | String as PropType\<Fields> | "day" | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 有效值 year,month,day，表示选择器的粒度 |
...
| @change | (event: [UniPickerChangeEvent](#unipickerchangeevent)) => void |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | value 改变时触发 change 事件，event.detail = {value: value} |
| @columnchange | (event: [UniPickerColumnChangeEvent](#unipickercolumnchangeevent)) => void |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 某一列的值改变时触发 columnchange 事件，event.detail = {column: column, value: value}，column 的值表示改变了第几列（下标从0开始），value 的值表示变更值的下标 |
| @cancel | (event: [UniPickerCancelEvent](#unipickercancelevent)) => void |   | Web: 4.0; 微信小程序: 4.41; Android: 5.08; iOS: 5.08; iOS(Vapor): 5.11; HarmonyOS: 4.61 | 取消选择时触发 |
