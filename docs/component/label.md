...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| disabled | boolean | false | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 是否禁用 |
| for | string |   | Web: 4.0; 微信小程序: 4.41; Android: x; iOS: x; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 绑定控件的 id |
