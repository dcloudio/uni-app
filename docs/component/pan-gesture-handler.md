...
| deltaX | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | 相对上一次，X 轴方向移动的坐标 |
| deltaY | Web: x; 微信小程序: 4.41; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | 相对上一次，Y 轴方向移动的坐标 |
