...
| :- | :- | :- | :- | :- | :- | :- | :- |
| 4.71 | 4.41 | 4.71 | 9.0 | 5.0 | 5.11 | 4.71 | 5.0 |


### 属性 
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| width | string \| number |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 页面宽度（px 为单位） |
| min-width | string \| number |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 页面最小宽度（px 为单位） |
| max-width | string \| number |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 页面最大宽度（px 为单位） |
| height | string \| number |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 页面高度（px 为单位） |
| min-height | string \| number |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 页面最小高度（px 为单位） |
| max-height | string \| number |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 页面最大高度（px 为单位） |
| orientation | portrait \| landscape |   | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; iOS(Vapor): 5.11; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 屏幕方向 |

#### orientation 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| portrait | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 竖屏 |
| landscape | Web: 4.71; 微信小程序: 4.41; Android: 4.71; iOS 系统版本: 9.0; iOS: 5.0; HarmonyOS: 4.71; HarmonyOS(Vapor): 5.0 | 横屏 |
