...
| user-select | boolean |   | Web: x; 微信小程序: 4.41; Android: x; iOS(VDOM): x; iOS(Vapor): 5.11; HarmonyOS: x | *(boolean)*<br/>文本是否可选，该属性会使文本节点显示为 inline-block |
...
- app-android平台，部分自定义字体不支持设置font-weight具体数值。
