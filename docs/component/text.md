...
| user-select | boolean |   | Web: x; 微信小程序: 4.41; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | *(boolean)*<br/>文本是否可选，该属性会使文本节点显示为 inline-block |
...
| max-lines | number |   | Web: x; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): 5.11; HarmonyOS 系统版本: 6.0; HarmonyOS: x; HarmonyOS(Vapor): 5.0 | 文本的最大行数，默认不限制最大行数 |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| ensp | Web: 4.0; 微信小程序:  ; Android: 3.9; iOS: 4.11; iOS(Vapor): x; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 中文字符空格一半大小 |
| emsp | Web: 4.0; 微信小程序:  ; Android: 3.9; iOS: 4.11; iOS(Vapor): x; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 中文字符空格大小 |
| nbsp | Web: 4.0; 微信小程序:  ; Android: 3.9; iOS: 4.11; iOS(Vapor): x; HarmonyOS: 4.61; HarmonyOS(Vapor): x | 根据字体设置的空格大小 |
...
| 子组件 | 兼容性 |
| :- | :- |
| [text](text.md) | Web: 4.0; 微信小程序: 4.41; Android: 3.9; iOS: 4.11; iOS(Vapor): 5.11; HarmonyOS: 4.61 |
