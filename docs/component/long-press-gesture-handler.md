...
| translationX | Web: x; 微信小程序: 4.41; Android: x; iOS: x; HarmonyOS: x; HarmonyOS(Vapor): - | 相对于初始触摸点的 X 轴偏移量 |
| translationY | Web: x; 微信小程序: 4.41; Android: x; iOS: x; HarmonyOS: x; HarmonyOS(Vapor): - | 相对于初始触摸点的 Y 轴偏移量 |
