...
| scroll-into-view | string([string.IDString](/uts/data-type.md#ide-string)) |   | Web: x; 微信小程序: x; Android: 4.41; iOS: 4.41; iOS(Vapor): x; HarmonyOS: x | 值应为某子元素id（id不能以数字开头）。设置哪个方向可滚动，则在哪个方向滚动到该元素起始位置 |
