...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| src | string([string.VideoURIString](/uts/data-type.md#ide-string)) |   | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 音视频地址。微信小程序支持 flv, rtmp 格式，app平台支持 rtmp, hls 协议 |
| mode | string |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM):   | live（直播），RTC（实时通话） |
| autoplay | boolean | false | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 自动播放 |
...
| object-fit | string | "contain" | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 填充模式，可选值有 contain，fillCrop |
| background-mute | boolean | false | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 进入后台时是否静音 |
| min-cache | string |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM):   | 最小缓冲区，单位s |
| max-cache | string |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM):   | 最大缓冲区，单位s |
| sound-mode | string |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(string)*<br/>声音输出方式 |
| auto-pause-if-navigate | boolean |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(boolean)*<br/>当跳转到本小程序的其他页面时，是否自动暂停本页面的实时音视频播放 |
| auto-pause-if-open-native | boolean |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(boolean)*<br/>当跳转到其它微信原生页面时，是否自动暂停本页面的实时音视频播放 |
...
| enable-casting | boolean |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(boolean)*<br/>是否支持投屏。开启后，可以通过 [LivePlayerContext]((LivePlayerContext)) 上相关方法进行操作。 |
| duration | number |   |   |   |
| initial-time | number |   |   |   |
| loop | boolean |   |   |   |
| codec | string |   |   |   |
...
| @statechange | (event: [UniLivePlayerStatechangeEvent](#uniliveplayerstatechangeevent)) => void |   | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 播放状态变化事件，event.detail = {code} |
| @fullscreenchange | (event: [UniLivePlayerFullscreenchangeEvent](#uniliveplayerfullscreenchangeevent)) => void |   | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 全屏变化事件，event.detail = {direction, fullScreen} |
| @error | (event: [UniLivePlayerErrorEvent](#uniliveplayererrorevent)) => void |   | Web: x; 微信小程序: x; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM):   | 错误事件，event.detail = {errCode, errMsg} |
...
| @audiovolumenotify | eventhandler |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(eventhandler)*<br/>播放音量大小通知，detail = {} |
...
| live | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x |  |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| contain | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM): x |  |
| fillCrop | Web: x; 微信小程序: 4.41; Android(VDOM): 4.81; iOS(VDOM): 4.81; HarmonyOS(VDOM): x |  |

#### sound-mode 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| speaker | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | 扬声器 |
| ear | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | 听筒 |
