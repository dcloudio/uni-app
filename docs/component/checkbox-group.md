...
| @change | (event: [UniCheckboxGroupChangeEvent](#unicheckboxgroupchangeevent)) => void | Web: 4.0; 微信小程序: 4.41; 支付宝小程序: 5.25; Android: 3.9; iOS: 4.11; HarmonyOS: 4.61 | checkbox-group中选中项发生改变是触发 change 事件，detail = {value:\[选中的checkbox的value的数组]} |
