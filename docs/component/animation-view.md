...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| path | string | "" | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 动画资源地址，目前只支持绝对路径 |
| loop | boolean | false | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 动画是否循环播放 |
| autoplay | boolean | false | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 动画是否自动播放 |
| action | string | "stop" | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 动画操作，可取值 play、pause、stop |
| hidden | boolean | false | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 是否隐藏动画 |
| @ended | (event: [UniEvent](/component/common.md#unievent)) => void |   | Web: √; 微信小程序: x; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 |   |

#### action 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| play | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 播放 |
| pause | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 暂停 |
| stop | Web: √; 微信小程序: √; Android: 3.9; iOS 系统版本: 13.0; iOS: 4.11; HarmonyOS: 5.0 | 停止 |
