...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| type | string |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(string)*<br/>布局方式 |
| cross-axis-count | number |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(number)*<br/>交叉轴元素数量 |
| max-cross-axis-extent | number |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(number)*<br/>交叉轴元素最大范围 |
| main-axis-gap | number |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(number)*<br/>主轴方向间隔 |
| cross-axis-gap | number |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(number)*<br/>交叉轴方向间隔 |
| padding | Array |   | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | *(Array)*<br/>长度为 4 的数组，按 top、right、bottom、left 顺序指定内边距 |

#### type 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| aligned | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | 每行高度由同一行中最大高度子节点决定 |
| masonry | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x | 瀑布流，根据子元素高度自动布局 |
