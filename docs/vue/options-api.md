...
| watch | 4.0 | 4.41 | 3.9 | x | 10.0 | 4.11 | x | 4.61 | x |
| emits | 4.0 | 4.41 | 3.9 | x | 10.0 | 4.11 | x | 4.61 | x |
...
|  | Web | 微信小程序 | Android | Android(Vapor) | iOS 系统版本 | iOS | iOS(Vapor) | HarmonyOS | HarmonyOS(Vapor) |
| :- | :- | :- | :- | :- | :- | :- | :- | :- | :- |
| name | 4.0 | 4.41 | 3.9 | x | 10.0 | 4.11 | x | 4.61 | x |
| inheritAttrs | 4.0 | √ | 3.9 | x | 10.0 | 4.11 | 5.11 | 4.61 | 5.03 |
...
| $page | Web: 4.31; 微信小程序: √; Android: 4.31; iOS 系统版本: 10.0; iOS: 4.31; iOS uni-app x UTS 插件: x; HarmonyOS: 4.61 |
