...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| name | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 用于自动生成 CSS 过渡类名。例如：name: 'fade' 将自动拓展为.fade-enter，.fade-enter-active等。默认类名为 "v" |
| appear | boolean |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 是否在初始渲染时使用过渡。默认为 false。 |
| css | boolean |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 是否使用 CSS 过渡类。默认为 true。如果设置为 false，将只通过组件事件触发注册的 JavaScript 钩子。 |
| type | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 指定过渡事件类型，侦听过渡何时结束。有效值为 "transition" 和 "animation"。默认 Vue.js 将自动检测出持续时间长的为过渡事件类型。 |
| mode | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 控制离开/进入的过渡时间序列。有效的模式有 "out-in" 和 "in-out"；默认同时生效。 |
| duration | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 指定过渡的持续时间。默认情况下，Vue 会等待过渡所在根元素的第一个 transitionend 或 animationend 事件。 |
| enter-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| leave-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| appear-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| enter-to-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| leave-to-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| appear-to-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| enter-active-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| leave-active-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| appear-active-class | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @before-enter | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @before-leave | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @before-appear | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @enter | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @leave | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @appear | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @after-enter | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @after-leave | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @after-appear | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @enter-cancelled | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @leave-cancelled | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | v-show only |
...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| tag | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 默认为 span。 |
| move-class | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 覆盖移动过渡期间应用的 CSS 类。 |
| name | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 用于自动生成 CSS 过渡类名。例如：name: 'fade' 将自动拓展为.fade-enter，.fade-enter-active等。默认类名为 "v" |
| appear | boolean |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 是否在初始渲染时使用过渡。默认为 false。 |
| css | boolean |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 是否使用 CSS 过渡类。默认为 true。如果设置为 false，将只通过组件事件触发注册的 JavaScript 钩子。 |
| type | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 指定过渡事件类型，侦听过渡何时结束。有效值为 "transition" 和 "animation"。默认 Vue.js 将自动检测出持续时间长的为过渡事件类型。 |
...
| @enter-cancelled | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
| @leave-cancelled | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | v-show only |
| @appear-cancelled | Any |   | Web: 4.0; 微信小程序: x; Android(VDOM): x; Android(Vapor): x; iOS(VDOM): x; iOS(Vapor): x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x |   |
...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| to | string |   | Web: 4.0; 微信小程序: x; Android(VDOM): 4.0; iOS(VDOM): 4.11; HarmonyOS(VDOM): 4.61 | 必须是有效的查询选择器或 HTMLElement (如果在浏览器环境中使用)。指定将在其中移动 \<teleport> 内容的目标元素 |
| disabled | boolean |   | Web: 4.0; 微信小程序: 5.14; Android(VDOM): 4.0; iOS(VDOM): 4.11; HarmonyOS(VDOM): 4.61 | 此可选属性可用于禁用 \<teleport> 的功能，这意味着其插槽内容将不会移动到任何位置，而是在您在周围父组件中指定了 \<teleport> 的位置渲染。 |
...
| 名称 | 类型 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| is | Any |   | Web: 4.0; 微信小程序: √; Android(VDOM): 3.99; iOS(VDOM): 4.11; HarmonyOS(VDOM): 4.61 |   |
| inline-template | boolean |   | Web: 4.0; 微信小程序: √; Android(VDOM): 3.99; iOS(VDOM): 4.11; HarmonyOS(VDOM): 4.61 |   |
