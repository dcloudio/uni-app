...
| onPageNotFound() | Web: 4.0; 微信小程序: 4.41; Android: x; Android(Vapor): x; iOS: x; iOS(Vapor): x; HarmonyOS: x |
| onUniNViewMessage() | Web: 4.0; 微信小程序: x; Android: x; Android(Vapor): x; iOS: x; iOS(Vapor): x; HarmonyOS: x |
| onThemeChange() | Web: x; 微信小程序: 4.41; Android: x; Android(Vapor): x; iOS: x; iOS(Vapor): x; HarmonyOS: x |
...
| :- | :- | :- | :- | :- | :- | :- | :- |
| version | 4.0 | 4.41 | √ | 5.11 | 4.11 | 5.11 | 4.61 |
| nextTick() | 4.0 | 4.41 | √ | x | 4.11 | 5.11 | 4.61 |
| defineComponent() | 4.0 | 4.41 | x | x | x | x | x |
