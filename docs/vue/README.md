...
在 uni-app x VDOM模式中，组合式和选项式是可以混合使用的。
...
在 uni-app x 蒸汽模式中，仅支持组合式，不支持选项式混合使用。
...
uni-app x 除web平台外，其他平台不支持使用 JSX/TSX 编写页面和组件，请使用 Vue 的 `template` 模板语法。
...
| 合法值 | 兼容性 |
| :- |  :-: |
| scss | Web: 4.0; 微信小程序: √; 支付宝小程序: 5.31; Android: 3.9; iOS: 4.11; HarmonyOS: 4.61 |
| less | Web: 4.0; 微信小程序: √; 支付宝小程序: 5.31; Android: 3.9; iOS: 4.11; HarmonyOS: 4.61 |
| stylus | Web: 4.0; 微信小程序: √; 支付宝小程序: 5.31; Android: 3.9; iOS: 4.11; HarmonyOS: 4.61 |
