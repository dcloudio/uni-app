...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **ExitOptions** | 否 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | uni.exit参数定义 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (res: [ExitSuccess](#exitsuccess-values)) => void | 否 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | uni.exit成功回调函数定义 |
| fail | (res: [ExitFail](#exitfail-values)) => void | 否 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | uni.exit失败回调函数定义 |
| complete | (res: any) => void | 否 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | uni.exit完成回调函数定义 | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errCode | number | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | 错误码 |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| 12001 | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | 系统不支持 |
| 12002 | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | 未知错误 |
| 12003 | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS:   | iOS平台，仅在uni-app x SDK模式中支持应用退出 |
