...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| pixelRatio | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 设备像素比<br/> |
...
| windowTop | number | 是 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 内容区域距离顶部的距离（同CSS变量 `--window-top`），单位为px<br/> |
| windowBottom | number | 是 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 内容区域距离底部的距离（同CSS变量 `--window-bottom`），单位为px<br/> |
| safeArea | **SafeArea** | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 安全区域在屏幕中的位置信息<br/> |
| safeAreaInsets | **SafeAreaInsets** | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 安全区域插入位置（与屏幕边界的距离）信息<br/> |
| screenTop | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 窗口上边缘的 y 值，单位为px<br/> |
| cutoutArea | Array&lt;**CutoutRect**&gt; | 否 |  | Web: x; 微信小程序: x; Android 系统版本: 9.0; Android(VDOM): 4.31; iOS: x; HarmonyOS(VDOM): x | 挖孔、刘海区域在屏幕中的位置信息<br/> |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| left | number | 是 |  | Web: x; 微信小程序: x; Android 系统版本: 9.0; Android(VDOM): 4.31; iOS: x; HarmonyOS(VDOM): x | 挖孔、刘海区域左上角横坐标，单位为px<br/> |
| right | number | 是 |  | Web: x; 微信小程序: x; Android 系统版本: 9.0; Android(VDOM): 4.31; iOS: x; HarmonyOS(VDOM): x | 挖孔、刘海区域右下角横坐标，单位为px<br/> |
| top | number | 是 |  | Web: x; 微信小程序: x; Android 系统版本: 9.0; Android(VDOM): 4.31; iOS: x; HarmonyOS(VDOM): x | 挖孔、刘海区域左上角纵坐标，单位为px<br/> |
| bottom | number | 是 |  | Web: x; 微信小程序: x; Android 系统版本: 9.0; Android(VDOM): 4.31; iOS: x; HarmonyOS(VDOM): x | 挖孔、刘海区域右下角纵坐标，单位为px<br/> | 
