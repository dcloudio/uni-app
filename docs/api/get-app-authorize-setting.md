...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| albumAuthorized | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.25; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 使用相册的开关<br/> |
| bluetoothAuthorized | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.25; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 使用蓝牙的开关<br/> |
| cameraAuthorized | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 使用摄像头的开关<br/> |
| locationAuthorized | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 使用定位的开关<br/> |
| locationAccuracy | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM):   | 定位准确度。<br/> |
| locationReducedAccuracy | boolean | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS: 4.11; HarmonyOS(VDOM):   | 定位准确度（推荐使用 locationAccuracy 属性）。true 表示模糊定位，false 表示精确定位（仅 iOS 支持） |
| microphoneAuthorized | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 使用麦克风的开关<br/> |
| notificationAuthorized | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 3.9; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 通知的开关<br/> |
| notificationAlertAuthorized | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 通知带有提醒的开关（仅 iOS 支持）<br/> |
| notificationBadgeAuthorized | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 通知带有标记的开关（仅 iOS 支持）<br/> |
| notificationSoundAuthorized | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS: 4.11; HarmonyOS(VDOM):   | 允许 App 通知带有声音的开关（仅 iOS 支持）<br/> |
| phoneCalendarAuthorized | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS: x; HarmonyOS(VDOM): x | 允许读写日历的开关（仅微信小程序支持）<br/> |
| readPhoneCalendarAuthorized | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 允许读日历的开关（仅鸿蒙支持）<br/> |
| writePhoneCalendarAuthorized | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 允许写日历的开关（仅鸿蒙支持）<br/> |
| pasteboardAuthorized | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 允许读取剪切版（仅鸿蒙支持）<br/> |

##### albumAuthorized 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| authorized | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 已经获得授权，无需再次请求授权 |
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | Android平台：表示没有配置[相册相关权限](https://doc.dcloud.net.cn/uni-app-x/native/permission/android_permission_adapter.html)，[权限配置详情](https://uniapp.dcloud.net.cn/tutorial/app-nativeresource-android.html#permissions)；iOS平台：当前应用没有配置相册权限描述 |
...
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | Android平台：表示没有配置[蓝牙相关权限](https://doc.dcloud.net.cn/uni-app-x/native/permission/android_permission_adapter.html)，[权限配置详情](https://uniapp.dcloud.net.cn/tutorial/app-nativeresource-android.html#permissions)；iOS平台：当前应用没有配置蓝牙权限描述 |
...
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | Android平台：表示没有配置 `android.permission.CAMERA` 权限，[权限配置详情](https://uniapp.dcloud.net.cn/tutorial/app-nativeresource-android.html#permissions)；iOS平台：当前应用没有配置相机权限描述 |
...
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | Android平台：表示没有配置 `android.permission.ACCESS_COARSE_LOCATION` 权限，[权限配置详情](https://uniapp.dcloud.net.cn/tutorial/app-nativeresource-android.html#permissions)；iOS平台：当前应用没有配置定位权限描述 |

##### locationAccuracy 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| reduced | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 模糊定位 |
| full | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 精准定位 |
| unsupported | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 不支持（包括用户拒绝定位权限和没有包含定位权限描述） |
...
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | Android平台：表示没有配置 `android.permission.RECORD_AUDIO` 权限，[权限配置详情](https://uniapp.dcloud.net.cn/tutorial/app-nativeresource-android.html#permissions)；iOS平台：当前应用没有配置麦克风权限描述 |
...
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | Android平台没有该值；iOS平台：没有包含推送权限描述 |
...
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求；（仅 iOS 会出现。此种情况下引导用户打开系统设置，不展示开关） |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 当前应用没有配置推送权限描述 |
...
| authorized | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 已经获得授权，无需再次请求授权 |
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权。Android平台：需要申请相册相关权限；iOS平台：此情况需要引导用户打开系统设置，在设置页中打开权限 |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求； |
| config error | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 当前应用没有配置推送权限描述 |
...
| :- |  :-: | :- |
| authorized | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 已经获得授权，无需再次请求授权 |
| denied | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 请求授权被拒绝，无法再次请求授权；（此情况需要引导用户打开系统设置，在设置页中打开权限） |
| not determined | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 尚未请求授权，会在App下一次调用系统相应权限时请求； |
