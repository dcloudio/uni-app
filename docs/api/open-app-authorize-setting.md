...
| complete | (result: [OpenAppAuthorizeSettingComplete](#openappauthorizesettingcomplete-values)) => void | 否 | null | Web: x; 微信小程序: 4.41; Android: 4.51; iOS: 4.51; iOS(VDOM) UTS 插件: 4.51; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
