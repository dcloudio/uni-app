...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| callback | (res: [OnUserCaptureScreenCallbackResult](#onusercapturescreencallbackresult-values)) => void | 否 | Web: x; 支付宝小程序: x | uni.onUserCaptureScreen/uni.offUserCaptureScreen回调函数定义 | 
