...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **SetAppThemeOptions** | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| theme | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 主题 |
| success | (result: [SetAppThemeSuccessResult](#setappthemesuccessresult-values)) => void | 否 | null | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [AppThemeFail](#appthemefail-values)) => void | 否 | null | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

##### theme 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| light | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 亮色模式 |
| dark | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 深色模式 |
| auto | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 跟随系统模式 |

#### SetAppThemeSuccessResult 的属性值 @setappthemesuccessresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| theme | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  |

#### AppThemeFail 的属性值 @appthemefail-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errCode | number | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 错误码<br/>- 702001  参数错误<br/>- 2002000  未知错误 |
| errSubject | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 统一错误主题（模块）名称 |
| data | any | 否 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 错误信息中包含的数据 |
| cause | [Error](https://uniapp.dcloud.net.cn/tutorial/err-spec.html#unierror) | 否 |  |   | 源错误信息，可以包含多个错误，详见SourceError |
| errMsg | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  |

#### errCode 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| 702001 | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 参数错误 |
| 2002000 | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 未知错误 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| callback | (res: [AppThemeChangeResult](#appthemechangeresult-values)) => void | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  | 

### AppThemeChangeResult 的属性值 @appthemechangeresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| appTheme | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 应用主题 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| id | number | 是 |  | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| callback | (res: [OsThemeChangeResult](#osthemechangeresult-values)) => void | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  | 

### OsThemeChangeResult 的属性值 @osthemechangeresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| osTheme | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 4.18; iOS: 4.18; iOS uni-app x UTS 插件: 4.18; HarmonyOS(VDOM): 4.71; HarmonyOS(Vapor): 5.0 | 系统主题 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| id | number | 是 |  | Web: x; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| callback | (result: [OnHostThemeChangeCallbackResult](#onhostthemechangecallbackresult-values)) => void | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  | 

### OnHostThemeChangeCallbackResult 的属性值 @onhostthemechangecallbackresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| hostTheme | string | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 主题名称 |

#### hostTheme 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| light | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 亮色模式 |
| dark | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 深色模式 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| id | number | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| callback | (result: [OnThemeChangeCallbackResult](#onthemechangecallbackresult-values)) => void | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  | 

### OnThemeChangeCallbackResult 的属性值 @onthemechangecallbackresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| theme | string | 是 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 主题名称 |
