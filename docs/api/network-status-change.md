...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| isConnected | boolean | 是 | Web: 4.0; 微信小程序: 4.41; 支付宝小程序: 5.31; Android: 4.81; iOS: 4.81; HarmonyOS: 4.61 | 当前是否有网络连接<br/> |
| networkType | string | 是 | Web: 4.0; 微信小程序: 4.41; 支付宝小程序: 5.31; Android: 4.81; iOS: 4.81; HarmonyOS: 4.61 | 网络类型(wifi、2g、3g、4g、5g、unknown、none)<br/> |
