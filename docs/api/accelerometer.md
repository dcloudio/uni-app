...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| x | number | 是 | 微信小程序: 4.41; 支付宝小程序: - | X 轴加速度数据 |
| y | number | 是 | 微信小程序: 4.41; 支付宝小程序: - | Y 轴加速度数据 |
| z | number | 是 | 微信小程序: 4.41; 支付宝小程序: - | Z 轴加速度数据 |
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| interval | string | 否 | 微信小程序: 4.41; 支付宝小程序: - | 监听加速度数据回调函数的执行频率 |
| success | (res: [StartAccelerometerSuccess](#startaccelerometersuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: - | 监听加速度数据调用成功的回调函数 |
| fail | (res: [StartAccelerometerFail](#startaccelerometerfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: - | 监听加速度数据调用失败的回调函数 |
| complete | (res: [StartAccelerometerSuccess](#startaccelerometersuccess-values) \| [StartAccelerometerFail](#startaccelerometerfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: - | 监听加速度数据调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| success | (res: [StopAccelerometerSuccess](#stopaccelerometersuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: - | 停止监听加速度数据调用成功的回调函数 |
| fail | (res: [StopAccelerometerFail](#stopaccelerometerfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: - | 停止监听加速度数据调用失败的回调函数 |
| complete | (res: [StopAccelerometerSuccess](#stopaccelerometersuccess-values) \| [StopAccelerometerFail](#stopaccelerometerfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: - | 停止监听加速度数据调用结束的回调函数（调用成功、失败都会执行） | 
