...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| filePath | string | 是 |  | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.61 | 文件路径，仅支持本地路径 |
| fileType | string | 否 |  | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.61 | 文件类型，指定文件类型打开文件，微信小程序仅支持类型：doc, xls, ppt, pdf, docx, xlsx, pptx，App端由系统打开，原则上可以打开任意文件； |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errCode | number | 是 |  | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.61 | 错误码 |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| 1300601 | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.71 | 路径无效 |
| 1300602 | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.71 | 文件不存在 |
| 1300603 | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.71 | 不支持该文件类型 |
| 1300604 | Web: x; 微信小程序: 4.41; Android: 4.71; iOS: 4.71; iOS(VDOM) uni-app x UTS 插件: 4.71; HarmonyOS: 4.71 | 其他未知错误 |
