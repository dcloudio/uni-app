...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| src | [string.VideoURIString](/uts/data-type.md#ide-string) | 是 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 视频文件路径，可以是临时文件路径也可以是永久文件路径 |
| success | (callback: [GetVideoInfoSuccess](#getvideoinfosuccess-values)) => void | 否 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 接口调用成功的回调函数 |
| fail | (callback: [GetVideoInfoFail](#getvideoinfofail-values)) => void | 否 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 接口调用失败的回调函数 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| orientation | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 画面方向 |
| type | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 视频格式 |
| duration | number | 是 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 视频长度 |
| size | number | 是 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 视频大小，单位 kB |
| height | number | 是 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 视频的长，单位 px |
| width | number | 是 |  | Web:  ; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM):   | 视频的宽，单位 px |
| fps | number | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM): x | 视频帧率 |
| bitrate | number | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.18; iOS: 4.25; HarmonyOS(VDOM): x | 视频码率，单位 kbps |
| thumbTempFilePath | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.61; iOS: 4.61; HarmonyOS(VDOM): x | 视频缩略图临时文件路径 |
| byteSize | number | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.61; iOS: 4.61; HarmonyOS(VDOM): x | 视频文件的字节大小 |
