...
| TEMP_PATH | string | 是 |  | Web: x; 微信小程序: x; Android 系统版本: x; Android: x; iOS 系统版本: x; iOS: x; HarmonyOS: 4.62 | 文件系统中的应用临时目录路径，应用退出自动清理 |
| ANDROID_INTERNAL_SANDBOX_PATH | string | 是 |  | Web: x; 微信小程序: x; Android: 3.99; iOS 系统版本: x; iOS: x; HarmonyOS 系统版本: x; HarmonyOS: x | 文件系统中的应用内置沙盒目录路径（仅app-android平台支持） |
