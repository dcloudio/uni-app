...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| USER_DATA_PATH | string | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 3.99; iOS: 4.11; HarmonyOS: 4.61 | 文件系统中的用户文件目录路径 |
| CACHE_PATH | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 3.99; iOS: 4.11; HarmonyOS: 4.61 | 文件系统中的缓存文件目录路径 |
| SANDBOX_PATH | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 3.99; iOS: 4.11; HarmonyOS: 4.61 | 文件系统中的应用沙盒目录路径 |
| TEMP_PATH | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): x; iOS: x; HarmonyOS: 4.62 | 文件系统中的应用临时目录路径，应用退出自动清理 |
| ANDROID_INTERNAL_SANDBOX_PATH | string | 是 |  | Web: x; 微信小程序: x; Android(VDOM): 3.99; iOS: x; HarmonyOS: x | 文件系统中的应用内置沙盒目录路径（仅app-android平台支持） |
...
<template>
  <view style="margin:12px">
    ...
    <page-intro content="本页演示 uni.env 文件系统路径：点击按钮查看 USER_DATA_PATH、CACHE_PATH、SANDBOX_PATH 等目录信息，可开关递归获取。"></page-intro>
