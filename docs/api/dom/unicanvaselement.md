...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| width | number | 是 |  | Web: 4.21; 微信小程序: x; Android: 4.25; iOS: 4.25; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | Canvas宽度(注意:App平台只读不支持设置) |
| height | number | 是 |  | Web: 4.21; 微信小程序: x; Android: 4.25; iOS: 4.25; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | Canvas高度(注意:App平台只读不支持设置) |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| contentType | string | 是 |  | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS(VDOM):  ; HarmonyOS(VDOM):   |  | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| callback | BlobCallback | 是 |  | Web:  ; 微信小程序: x; Android(VDOM): x; iOS(VDOM): x; HarmonyOS(VDOM): x |  | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| type | string | 否 |  | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS(VDOM):  ; HarmonyOS(VDOM):   |  |
| encoderOptions | any | 否 |  | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS(VDOM):  ; HarmonyOS(VDOM):   |  | 
