...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| borderBoxSize | Array&lt;**UniBorderBoxSize**&gt; | 是 |  | Web: 4.16; 微信小程序: x; Android: 4.13; iOS: 4.18; HarmonyOS(VDOM): 4.61 | 只读属性 包含被监视的元素带有边框box大小的数组。 |
| contentBoxSize | Array&lt;**UniContentBoxSize**&gt; | 是 |  | Web: 4.16; 微信小程序: x; Android: 4.13; iOS: 4.18; HarmonyOS(VDOM): 4.61 | 只读属性 包含被监视的元素内容box大小的数组。 |
| devicePixelContentBoxSize | Array&lt;**UniDevicePixelContentBoxSize**&gt; | 是 |  | Web: 4.16; 微信小程序: x; Android: 4.13; iOS: 4.18; HarmonyOS(VDOM): 4.61 | 只读属性 包含被监视的元素内容box设备像素大小的数组。 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| target | [UniElement](/api/dom/unielement.md) | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.0; iOS(VDOM): 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 被监视的 UniElement | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| target | [UniElement](/api/dom/unielement.md) | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.0; iOS(VDOM): 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 取消监视的 UniElement | 
