...
| isConnected | boolean | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS 系统版本: 12; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素是否与 DOM 树连接 |
| attributes | Map\<string, any> | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素上所有属性元素的集合 |
| classList | Array&lt;string&gt; | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: x; HarmonyOS(VDOM):   | 只读属性，当前元素 class 属性的动态集合 |
| dataset | Map\<string, any> | 是 |  | Web: 4.0; 微信小程序: 4.41 仅在event对象内的target上可用; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: x; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 只读属性，当前元素上自定义数据属性（data-*）的集合 |
| children | Array&lt;[UniElement](/api/dom/unielement.md)&gt; | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素包含的子元素的集合 |
| firstChild | [UniElement](/api/dom/unielement.md) | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM):   | 只读属性，当前元素的第一个子元素，如果元素是无子元素，则返回 null |
| lastChild | [UniElement](/api/dom/unielement.md) | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM):   | 只读属性，当前元素的最后一个子元素，如果没有子元素，则返回 null |
| parentElement | [UniElement](/api/dom/unielement.md) | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素在 DOM 树中的父元素，如果没有父元素（如未添加到DOM树中），则返回null。 |
| nextElementSibling | [UniElement](/api/dom/unielement.md) | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素在 DOM 树中紧跟在其后面的同级元素，如果当前元素为最后一个元素，则返回 null |
| offsetLeft | number | 是 |  | Web: 4.0; 微信小程序: 4.41 仅在event对象内的target上可用; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素左上角相对于其定位父元素内边框（Border内侧）左边缘的逻辑像素值 |
| offsetTop | number | 是 |  | Web: 4.0; 微信小程序: 4.41 仅在event对象内的target上可用; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素外边框左上角相对于其定位父元素内边框（Border内侧）顶部边缘的逻辑像素值 |
| offsetWidth | number | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素的布局宽度逻辑像素值，包含border、padding区域 |
| offsetHeight | number | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素的布局高度逻辑像素值，包含border、padding区域 |
| style | [CSSStyleDeclaration](/api/dom/cssstyledeclaration.md) | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 只读属性，当前元素的CSS样式对象 |
| scrollWidth | number | 是 |  | Web: 4.0; 微信小程序: 5.13; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素的可滚动内容总宽度，仅scroll-view、list-view等可滚动组件支持，其他组件返回视图宽度 |
| scrollHeight | number | 是 |  | Web: 4.0; 微信小程序: 5.13; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素可滚动内容的总高度，仅scroll-view、list-view等可滚动组件支持，其他组件返回视图高度 |
| scrollLeft | number | 是 |  | Web: 4.0; 微信小程序: 5.13; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 获取或修改当前元素横向滚动的逻辑像素值，仅scroll-view、list-view等可滚动组件支持，其他组件修改无效、获取时返回 0 |
| scrollTop | number | 是 |  | Web: 4.0; 微信小程序: 5.13; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61 | 获取或修改当前元素竖向滚动逻辑像素值，仅scroll-view、list-view可滚动组件组件支持，其他组件修改无效、获取时返回 0 |
| tagName | string | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.0; iOS: 4.11; iOS uni-app x UTS 插件: 4.25; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 只读属性，获取当前元素的标签名 |
| uniPage | [UniPage](/api/unipage.md) | 是 |  | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: x; HarmonyOS 系统版本: 12; HarmonyOS(VDOM): 4.61 | 只读属性，当前元素所属的页面对象 |
| innerHTML | string | 是 |  | Web: x; 微信小程序: x; Android: 4.84; iOS: x; iOS uni-app x UTS 插件: x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 只读属性，当前元素内部所有子元素（不包括注释节点）的 HTML 内容 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| aChild | [UniElement](/api/dom/unielement.md) | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.0; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 插入子元素对象 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| newChild | [UniElement](/api/dom/unielement.md) | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.0; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 插入子元素对象 |
| refChild | [UniElement](/api/dom/unielement.md) | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.0; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 所有组件的 DOM 元素对象基类，描述了 UVUE DOM 元素所普通具有的属性和方法。 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| key | string | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 属性名称 |
| value | string | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 属性值域 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| key | string | 是 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 属性名称 |
| value | any | 是 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 属性值域 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| type | string | 是 |  | Web:  ; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x | 事件类型 |
| callback | (event: T) => R | 是 |  | Web:  ; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x | 事件监听器 T表示event类型，R表示返回值类型 | 
...
| :- | :- | :- | :- |  :-: | :- |
| type | string | 是 |  | Web:  ; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x | 事件类型 |
| callbackWrapper | UniCallbackWrapper | 是 |  | Web:  ; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x | 事件监听回调封装类 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| aChild | [UniElement](/api/dom/unielement.md) | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.0; iOS: 4.11; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 被删除子元素对象 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| x | number | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | x轴要滚动到坐标位置(单位px) |
| y | number | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | y轴要滚动到坐标位置(单位px) | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| x | number | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | x轴要滚动的距离(单位px) |
| y | number | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | y轴要滚动的距离(单位px) | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| selector | [string.cssSelectorString](/uts/data-type.md#ide-string) | 是 |  | Web:  ; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | CSS 选择器字符串 | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| keyframes | [UniAnimationKeyframe](#unianimationkeyframe-values) \| Array&lt;[UniAnimationKeyframe](#unianimationkeyframe-values)&gt; | 是 |  |   | 关键帧对象数组或一个关键帧对象。 |
| options | [UniAnimationOption](#unianimationoption-values) \| number | 是 |  |   | 动画属性配置。 | 
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| backwards | Web: √; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 动画播放完毕后恢复初始状态 |
| forwards | Web: √; 微信小程序: x; Android: 4.51; iOS: 4.53; HarmonyOS(VDOM): x; HarmonyOS(Vapor): 5.08 | 动画播放完毕后保留状态 |
| both | Web: √; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 动画播放完毕后保留状态 |
| none | Web: √; 微信小程序: x; Android: x; iOS: x; HarmonyOS(VDOM): x; HarmonyOS(Vapor): x | 动画播放完毕后恢复初始状态 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| event | [UniAnimationPlaybackEvent](#unianimationplaybackevent-values) | 是 |  |   |  | 
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **RequestFullscreenOptions** | 否 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| navigationUI | string | 否 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 全屏模式时导航栏状态 |
| orientation | string | 否 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 全屏显示方向 |
| success | () => void | 否 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 成功回调 |
| fail | (error: [IFullscreenError](#ifullscreenerror-values)) => void | 否 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 失败回调 |
| complete | (result?: any) => void | 否 |  | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 完成回调 | 

##### navigationUI 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| hide | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 隐藏所有系统状态栏和底部导航栏 |
| show | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 隐藏顶部系统状态栏，显示底部系统导航栏 |
| auto | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 系统默认行为 |

##### orientation 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| auto | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 根据重力感应自动调整 |
| landscape | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 固定为横屏，会根据重力调整方向 |
| landscape-secondary | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 固定为反向横屏 |
| landscape-primary | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 固定为正向横屏 |
| portrait | Web: x; 微信小程序: x; Android:  ; iOS:  ; HarmonyOS(VDOM):   | 固定为竖屏 |
