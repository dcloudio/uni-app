...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| points | Array&lt;**LocationObject**&gt; | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 要显示在可视区域内的坐标点列表，\[{latitude, longitude}\] |
| success | (result: any) => void | 否 | null | 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (result: [MapContextFail](#mapcontextfail-values)) => void | 否 | null | 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | 支付宝小程序: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| markers | Array&lt;**Marker**&gt; | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 同传入 map 组件的 marker 属性 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| id | number | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 标记点id，marker点击事件回调会返回此id。建议为每个marker设置上Number类型id，保证更新marker时有更好的性能。最大限制9位数 |
| latitude | number | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 纬度，浮点数，范围 -90 ~ 90 |
| longitude | number | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 经度，浮点数，范围 -180 ~ 180 |
| iconPath | string | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 显示的图标，项目目录下的图片路径，支持相对路径写法，以'/'开头则表示相对小程序根目录；也支持临时路径 |
| title | string | 否 | null | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 标注点名，点击时显示，callout存在时将被忽略 |
| rotate | number | 否 | 0 | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 旋转角度，顺时针旋转的角度，范围 0 ~ 360 |
| alpha | number | 否 | 1 | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 标注的透明度，范围 0 ~ 1 |
| width | number | 否 | 默认为图片实际宽度 | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 标注图标宽度 |
| height | number | 否 | 默认为图片实际高度 | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 标注图标高度 |
| ariaLabel | string | 否 | null | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS: 4.31; HarmonyOS: 4.61 | 无障碍访问，（属性）元素的额外描述 |
| anchor | **Anchor** | 否 | \[0.5, 1\] | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 经纬度在标注图标的锚点，默认底边中点	{x, y}，x表示横向(0-1)，y表示竖向(0-1)。{x: .5, y: 1} 表示底边中点 |
| callout | **MapMarkerCallout** | 否 | null | 支付宝小程序: x; Android: 4.51; iOS: 4.51; HarmonyOS: x | 自定义标记点上方的气泡窗口 |
| label | **MapMarkerLabel** | 否 | null | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11; HarmonyOS: x | 为标记点旁边增加标签 |
| clusterId | number | 否 | null | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11; HarmonyOS: x | 自定义点聚合簇效果时使用 |
| customCallout | **MapMarkerCallout** | 否 | null | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11; HarmonyOS: x | 自定义气泡窗口 |
| joinCluster | boolean | 否 | null | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11; HarmonyOS: x | 是否参与点聚合 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| content | string | 否 | "" | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 文本 |
| color | [string.ColorString](/uts/data-type.md#ide-string) | 否 | "black" | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 文本颜色 |
| fontSize | number | 否 | null | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 文字大小 |
| borderRadius | number | 否 | 0 | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 边框圆角 |
| borderWidth | number | 否 | 0 | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 边框宽度 |
| borderColor | [string.ColorString](/uts/data-type.md#ide-string) | 否 | "transparent" | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 边框颜色 |
| bgColor | [string.ColorString](/uts/data-type.md#ide-string) | 否 | "#fff" | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 背景色 |
| padding | number | 否 | 0 | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 文本边缘留白 |
| display | string | 否 | "BYCLICK" | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 'BYCLICK':点击显示; 'ALWAYS':常显 |
| textAlign | string | 否 | "left" | 支付宝小程序: x; Android: 4.51; iOS: 4.51 | 文本对齐方式。 |
| anchorX | number | 否 | 0.5 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 横向偏移量，向右为正数 |
| anchorY | number | 否 | 1 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 纵向偏移量，向下为正数 |
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| content | string | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 文本 |
| color | string | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 文本颜色 |
| fontSize | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 文字大小 |
| x | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | label的坐标，原点是 marker 对应的经纬度 |
| y | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | label的坐标，原点是 marker 对应的经纬度 |
| anchorX | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | label的坐标，原点是 marker 对应的经纬度 |
| anchorY | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | label的坐标，原点是 marker 对应的经纬度 |
| borderWidth | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 边框宽度 |
| borderColor | string | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 边框颜色 |
| borderRadius | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 边框圆角 |
| bgColor | string | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 背景色 |
| padding | number | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 文本边缘留白 |
| textAlign | string | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 文本对齐方式。 |
| ariaLabel | string | 否 | 支付宝小程序: x; Android(VDOM): x; Android(Vapor): 5.21; iOS(VDOM): x; iOS(Vapor): 5.11 | 无障碍访问，（属性）元素的额外描述 |
...
| :- | :- | :- | :- |  :-: | :- |
| markerId | number | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 指定marker |
| path | Array&lt;**LocationObject**&gt; | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 移动路径的坐标串，坐标点格式 {longitude, latitude} |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| markerIds | Array&lt;number&gt; | 是 |  | 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 要被删除的marker的id属性组成的数组 |
| success | (result: any) => void | 否 | null | 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (result: [MapContextFail](#mapcontextfail-values)) => void | 否 | null | 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | 支付宝小程序: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
