...
| :- | :- | :- | :- | :- | :- |
| 4.0 | 4.41 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 3.9.0 | 4.11 | 4.61 |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| options | **SetStorageOptions** | 是 | 支付宝小程序: x |

#### options 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| key | string | 是 | 支付宝小程序: x | 本地存储中的指定的 key |
| data | any | 是 | 支付宝小程序: x | 需要存储的内容，只支持能通过 JSON.stringify 序列化的对象 |
| success | (res: SetStorageSuccess) => void | 否 | 支付宝小程序: x | uni.setStorage成功回调函数定义 |
| fail | (res: [UniError](https://uniapp.dcloud.net.cn/tutorial/err-spec.html#unierror)) => void | 否 | 支付宝小程序: x | uni.setStorage失败回调函数定义 |
| complete | (res: any) => void | 否 | 支付宝小程序: x | uni.setStorage完成回调函数定义 | 
...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| key | string | 是 | 支付宝小程序: x | 本地storage存储中的指定的 key |
| data | any | 是 | 支付宝小程序: x | 需要存储的内容，只支持能通过 JSON.stringify 序列化的对象 | 
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| options | **GetStorageOptions** | 是 | 支付宝小程序: x |
...
| :- | :- | :- |  :-: | :- |
| key | string | 是 | 支付宝小程序: x | 本地存储中的指定的 key |
| success | (res: [GetStorageSuccess](#getstoragesuccess-values)) => void | 否 | 支付宝小程序: x | uni.getStorage成功回调函数定义 |
| fail | (res: [UniError](https://uniapp.dcloud.net.cn/tutorial/err-spec.html#unierror)) => void | 否 | 支付宝小程序: x | uni.getStorage失败回调函数定义 |
| complete | (res: any) => void | 否 | 支付宝小程序: x | uni.getStorage完成回调函数定义 | 

#### GetStorageSuccess 的属性值 @getstoragesuccess-values 

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| data | any | 否 | 支付宝小程序: x | key 对应的内容 |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| options | **GetStorageInfoOptions** | 是 | 支付宝小程序: x |

#### options 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| success | (res: [GetStorageInfoSuccess](#getstorageinfosuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.getStorageInfo成功回调函数定义 |
| fail | (res: [UniError](https://uniapp.dcloud.net.cn/tutorial/err-spec.html#unierror)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.getStorageInfo失败回调函数定义 |
| complete | (res: any) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.getStorageInfo完成回调函数定义 | 

#### GetStorageInfoSuccess 的属性值 @getstorageinfosuccess-values 

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| keys | Array&lt;string&gt; | 是 | 微信小程序: 4.41; 支付宝小程序: x | 当前 storage 中所有的 key |
| currentSize | number | 是 | 微信小程序: 4.41; 支付宝小程序: x | 当前占用的空间大小, 单位：kb |
| limitSize | number | 是 | 微信小程序: 4.41; 支付宝小程序: x | 限制的空间大小, 单位：kb |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| options | **RemoveStorageOptions** | 是 | 支付宝小程序: x |

#### options 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| key | string | 是 | 微信小程序: 4.41; 支付宝小程序: x | 本地存储中的指定的 key |
| success | (res: RemoveStorageSuccess) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.removeStorage成功回调函数定义 |
| fail | (res: [UniError](https://uniapp.dcloud.net.cn/tutorial/err-spec.html#unierror)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.removeStorage失败回调函数定义 |
| complete | (res: any) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.removeStorage完成回调函数定义 | 
...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| option | **ClearStorageOptions** | 否 | 支付宝小程序: x | uni.clearStorage参数定义 |

#### option 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| success | (res: ClearStorageSuccess) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.clearStorage 成功回调函数定义 |
| fail | (res: [UniError](https://uniapp.dcloud.net.cn/tutorial/err-spec.html#unierror)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.clearStorage 失败回调函数定义 |
| complete | (res: any) => void | 否 | 微信小程序: 4.41; 支付宝小程序: x | uni.clearStorage 完成回调函数定义 | 
