...
| content | string | 否 | Web: 4.0; 微信小程序: 4.41; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 4.61 | editable 为 true 时，用户输入的文本 |
| cancel | boolean | 是 | Web: 4.0; 微信小程序: 4.41; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 4.61 | 为 true 时，表示用户点击了取消（用于 Android 系统区分点击蒙层关闭还是点击取消按钮关闭） |
| confirm | boolean | 是 | Web: 4.0; 微信小程序: 4.41; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 4.61 | 为 true 时，表示用户点击了确定按钮 |
