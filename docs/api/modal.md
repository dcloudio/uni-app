...
| Web | 微信小程序 | Android(VDOM) | iOS | iOS uni-app x UTS 插件 | HarmonyOS(VDOM) | HarmonyOS(Vapor) |
| :- | :- | :- | :- | :- | :- | :- |
| 4.0 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.61 | 4.61 | 4.61 | 4.61 | 5.0 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **HideModalOptions** | 否 |  | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| modalPage | [UniPage](/api/unipage.md) | 否 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 4.61; iOS: 4.61; iOS uni-app x UTS 插件: x; HarmonyOS 系统版本: 12; HarmonyOS(VDOM): 4.61 | 期望隐藏的目标 modal，如果为 null 会关闭当前栈顶全部 modal |
| success | (result: [HideModalSuccess](#hidemodalsuccess-values)) => void | 否 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [HideModalFail](#hidemodalfail-values)) => void | 否 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errCode | number | 是 |  | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  |
