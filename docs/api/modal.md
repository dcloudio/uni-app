...
| showCancel | boolean | 否 | true<br/>是否显示取消按钮，默认为 true | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 |  |
| cancelText | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 取消按钮的文字，默认为"取消" |
| cancelColor | [string.ColorString](/uts/data-type.md#ide-string) | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 取消按钮的文字颜色，默认为"#000000" |
| confirmText | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 确定按钮的文字，默认为"确定" |
| confirmColor | [string.ColorString](/uts/data-type.md#ide-string) | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 确定按钮的文字颜色 |
| editable | boolean | 否 | false | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 是否显示输入框 |
| placeholderText | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 显示输入框时的提示文本 |
| success | (result: [ShowModalSuccess](#showmodalsuccess-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 接口调用成功的回调函数 |
| fail | (result: [ShowModalFail](#showmodalfail-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| cancel | boolean | 是 | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 为 true 时，表示用户点击了取消（用于 Android 系统区分点击蒙层关闭还是点击取消按钮关闭） |
| confirm | boolean | 是 | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 为 true 时，表示用户点击了确定按钮 |
...
| fail | (result: [HideModalFail](#hidemodalfail-values)) => void | 否 | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS(VDOM) UTS 插件: 4.61; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
