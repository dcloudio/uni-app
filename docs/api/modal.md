...
| :- | :- | :- | :- | :- | :- | :- |
| 4.0 | 4.41 | 4.61 | 4.61 | 4.61 | 4.61 | 5.03 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| title | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 提示的标题 |
| content | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 提示的内容 |
| showCancel | boolean | 否 | true<br/>是否显示取消按钮，默认为 true | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 |  |
| cancelText | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 取消按钮的文字，默认为"取消" |
| cancelColor | [string.ColorString](/uts/data-type.md#ide-string) | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 取消按钮的文字颜色，默认为"#000000" |
| confirmText | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 确定按钮的文字，默认为"确定" |
| confirmColor | [string.ColorString](/uts/data-type.md#ide-string) | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 确定按钮的文字颜色 |
| editable | boolean | 否 | false | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 是否显示输入框 |
| placeholderText | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 显示输入框时的提示文本 |
| success | (result: [ShowModalSuccess](#showmodalsuccess-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 接口调用成功的回调函数 |
| fail | (result: [ShowModalFail](#showmodalfail-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

#### ShowModalSuccess 的属性值 @showmodalsuccess-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errMsg | string | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 错误信息 |
| content | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | editable 为 true 时，用户输入的文本 |
| cancel | boolean | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 为 true 时，表示用户点击了取消（用于 Android 系统区分点击蒙层关闭还是点击取消按钮关闭） |
| confirm | boolean | 是 |  | Web: 4.0; 微信小程序: 4.41; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 为 true 时，表示用户点击了确定按钮 |
...
| Web | 微信小程序 | Android | iOS | iOS uni-app x UTS 插件 | HarmonyOS(VDOM) | HarmonyOS(Vapor) |
| :- | :- | :- | :- | :- | :- | :- |
| 4.0 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.61 | 4.61 | 4.61 | 4.61 | 5.03 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| modalPage | [UniPage](/api/unipage.md) | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: x; HarmonyOS 系统版本: 12; HarmonyOS: 4.61 | 期望隐藏的目标 modal，如果为 null 会关闭当前栈顶全部 modal |
| success | (result: [HideModalSuccess](#hidemodalsuccess-values)) => void | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 接口调用成功的回调函数 |
| fail | (result: [HideModalFail](#hidemodalfail-values)) => void | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 |  | Web: 4.0; 微信小程序: x; Android: 4.61; iOS: 4.61; iOS uni-app x UTS 插件: 4.61; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.03 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
