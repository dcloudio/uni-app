...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| interval | string | 否 | Web: x; 支付宝小程序: x | 监听陀螺仪数据回调函数的执行频率 |
| success | (res: [StartGyroscopeSuccess](#startgyroscopesuccess-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (res: [StartGyroscopeFail](#startgyroscopefail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (res: [StartGyroscopeSuccess](#startgyroscopesuccess-values) \| [StartGyroscopeFail](#startgyroscopefail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| success | (res: [StopGyroscopeSuccess](#stopgyroscopesuccess-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (res: [StopGyroscopeFail](#stopgyroscopefail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (res: [StopGyroscopeSuccess](#stopgyroscopesuccess-values) \| [StopGyroscopeFail](#stopgyroscopefail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| x | number | 是 | Web: x; 支付宝小程序: x | x 轴的角速度 |
| y | number | 是 | Web: x; 支付宝小程序: x | y 轴的角速度 |
| z | number | 是 | Web: x; 支付宝小程序: x | z 轴的角速度 |
