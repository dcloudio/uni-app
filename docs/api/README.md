...
uni-agent，可以方便的开发uts插件，封装原生能力，供页面使用。即便不懂原生开发，也可以指挥AI完成uts插件开发。[详见](https://doc.dcloud.net.cn/uni-app-x/ai/)
...
还有很多API通过第二个参数可以指定所需要的页面，不传第二个参数时默认也是从栈顶页面找。
