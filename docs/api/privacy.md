...
| :- | :- | :- | :- | :- | :- |
| <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.41 | 4.31 | 4.31 | 4.31 | 4.61 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (result: [GetPrivacySettingSuccessResult](#getprivacysettingsuccessresult-values)) => void | 否 | null | Web: x; 微信小程序: 4.41; Android: 4.31; iOS: 4.31; iOS(VDOM) uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 接口调用成功的回调函数 |
| fail | (result: any) => void | 否 | null | Web: x; 微信小程序: 4.41; Android: 4.31; iOS: 4.31; iOS(VDOM) uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Web: x; 微信小程序: 4.41; Android: 4.31; iOS: 4.31; iOS(VDOM) uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| :- | :- | :- | :- | :- |
| <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.31 | 4.31 | 4.31 | 4.61 |
