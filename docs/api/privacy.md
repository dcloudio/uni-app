...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **GetPrivacySettingOptions** | 是 |  | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (result: [GetPrivacySettingSuccessResult](#getprivacysettingsuccessresult-values)) => void | 否 | null | Web: x; 微信小程序: 4.41; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 接口调用成功的回调函数 |
| fail | (result: any) => void | 否 | null | Web: x; 微信小程序: 4.41; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Web: x; 微信小程序: 4.41; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

#### GetPrivacySettingSuccessResult 的属性值 @getprivacysettingsuccessresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| needAuthorization | boolean | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 是否需要用户授权隐私协议(用户之前同意过返回false，没同意过则返回true) |
| privacyContractName | string | 否 |  | Web: x; 微信小程序: 4.41; Android(VDOM):  ; iOS:  ; HarmonyOS:   | 隐私授权协议的名称<br/> |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| callback | (res: [PrivacyChangeResult](#privacychangeresult-values)) => void | 是 |  | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  | 

### PrivacyChangeResult 的属性值 @privacychangeresult-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| needAuthorization | boolean | 是 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS: 4.61 | 是否需要用户授权隐私协议(用户之前同意过返回false，没同意过则返回true) |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| id | number | 是 |  | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 开启监听隐私协议状态改变返回的id | 
