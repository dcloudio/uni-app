...
| :- | :- | :- | :- | :- | :- | :- |
| 4.0 | 4.41 | 3.9.0 | 4.11 | 5.0.0(11) | 4.61 | 5.0 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| provider | string | 否 | system | Web: x; 微信小程序: x; Android(VDOM): 4.25; iOS: 4.25; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 定位服务提供商，通过 [uni.getProvider](https://doc.dcloud.net.cn/uni-app-x/api/provider.html) 获取,目前支持系统定位(system)、腾讯定位(tencent)<br/>腾讯定位是4.25版本后支持的；<br/>web端暂不支持provider机制； |
| type | string | 否 | wgs84 | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 默认为 wgs84 返回 gps 坐标，gcj02 返回可用于uni.openLocation的坐标，web端需配置定位 SDK 信息才可支持 gcj02； |
| altitude | boolean | 否 | false | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 传入 true 会返回高度信息，由于获取高度需要较高精确度，会减慢接口返回速度 |
| geocode | boolean | 否 | false | Web: x; 微信小程序: x; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS(VDOM): x | 传入 true 会解析地址；<br/>使用系统定位时平台差异：iOS支持逆地理编码，Android、HarmonyOS 不支持； |
| highAccuracyExpireTime | number | 否 | 3000 | Web: x; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 高精度定位超时时间(ms)，指定时间内返回最高精度，该值3000ms以上高精度定位才有效果 |
| isHighAccuracy | boolean | 否 | false | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 开启高精度定位 |
| success | (result: [GetLocationSuccess](#getlocationsuccess-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [GetLocationFail](#getlocationfail-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS 系统版本: 5.0.0(11); HarmonyOS(VDOM): 4.81; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

##### type 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| wgs84 | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS(VDOM):   | wgs84坐标系，系统定位默认取值wgs84，系统定位仅支持wgs84坐标系 |
| gcj02 | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 3.9.0; iOS: 4.11; HarmonyOS(VDOM):   | gcj02坐标系，腾讯定位默认取值gcj02，腾讯定位仅支持gcj02坐标系 |
