...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| photoFilePath | string | 否 | Web: x; 支付宝小程序: x | 头像本地文件路径 |
| nickName | string | 否 | Web: x; 支付宝小程序: x | 昵称 |
| lastName | string | 否 | Web: x; 支付宝小程序: x | 姓氏 |
| middleName | string | 否 | Web: x; 支付宝小程序: x | 中间名 |
| firstName | string | 否 | Web: x; 支付宝小程序: x | 名字 |
| remark | string | 否 | Web: x; 支付宝小程序: x | 备注 |
| mobilePhoneNumber | string | 否 | Web: x; 支付宝小程序: x | 手机号 |
| weChatNumber | string | 否 | Web: x; 支付宝小程序: x | 即时消息账号 |
| addressCountry | string | 否 | Web: x; 支付宝小程序: x | 联系地址国家 |
| addressState | string | 否 | Web: x; 支付宝小程序: x | 联系地址省份 |
| addressCity | string | 否 | Web: x; 支付宝小程序: x | 联系地址城市 |
| addressStreet | string | 否 | Web: x; 支付宝小程序: x | 联系地址街道 |
| addressPostalCode | string | 否 | Web: x; 支付宝小程序: x | 联系地址邮政编码 |
| organization | string | 否 | Web: x; 支付宝小程序: x | 公司 |
| title | string | 否 | Web: x; 支付宝小程序: x | 职位 |
| workFaxNumber | string | 否 | Web: x; 支付宝小程序: x | 工作传真 |
| workPhoneNumber | string | 否 | Web: x; 支付宝小程序: x | 工作电话 |
| hostNumber | string | 否 | Web: x; 支付宝小程序: x | 公司电话 |
| email | string | 否 | Web: x; 支付宝小程序: x | 电子邮件 |
| url | string | 否 | Web: x; 支付宝小程序: x | 网站 |
| workAddressCountry | string | 否 | Web: x; 支付宝小程序: x | 工作地址国家 |
| workAddressState | string | 否 | Web: x; 支付宝小程序: x | 工作地址省份 |
| workAddressCity | string | 否 | Web: x; 支付宝小程序: x | 工作地址城市 |
| workAddressStreet | string | 否 | Web: x; 支付宝小程序: x | 工作地址街道 |
| workAddressPostalCode | string | 否 | Web: x; 支付宝小程序: x | 工作地址邮政编码 |
| homeFaxNumber | string | 否 | Web: x; 支付宝小程序: x | 住宅传真 |
| homePhoneNumber | string | 否 | Web: x; 支付宝小程序: x | 住宅电话 |
| homeAddressCountry | string | 否 | Web: x; 支付宝小程序: x | 住宅地址国家 |
| homeAddressState | string | 否 | Web: x; 支付宝小程序: x | 住宅地址省份 |
| homeAddressCity | string | 否 | Web: x; 支付宝小程序: x | 住宅地址城市 |
| homeAddressStreet | string | 否 | Web: x; 支付宝小程序: x | 住宅地址街道 |
| homeAddressPostalCode | string | 否 | Web: x; 支付宝小程序: x | 住宅地址邮政编码 |
| success | (result: AddPhoneContactSuccess) => void | 否 | Web: x; 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (result: [AddPhoneContactFail](#addphonecontactfail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (result: AddPhoneContactSuccess \| [AddPhoneContactFail](#addphonecontactfail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| success | (result: [ChooseContactSuccess](#choosecontactsuccess-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (result: [ChooseContactFail](#choosecontactfail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (result: [ChooseContactSuccess](#choosecontactsuccess-values) \| [ChooseContactFail](#choosecontactfail-values)) => void | 否 | Web: x; 支付宝小程序: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 

#### ChooseContactSuccess 的属性值 @choosecontactsuccess-values 

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| displayName | string | 是 | Web: x; 支付宝小程序: x | 联系人姓名 |
| phoneNumber | string | 是 | Web: x; 支付宝小程序: x | 当前选中的手机号 |
| phoneNumberList | Array&lt;string&gt; | 是 | Web: x; 支付宝小程序: x | 联系人的所有手机号 |
