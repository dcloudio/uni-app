...
| :- | :- | :- | :- | :- | :- |
| <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.41 | 5.31 | 4.61 | 4.61 | 5.22 |
...
| success | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 接口调用成功的回调函数 |
| fail | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 接口调用失败的回调函数 |
