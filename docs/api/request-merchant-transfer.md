...
| success | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.61; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 接口调用成功的回调函数 |
| fail | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.61; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 接口调用失败的回调函数 |
