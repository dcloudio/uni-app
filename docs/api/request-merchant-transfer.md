...
| :- | :- | :- | :- | :- | :- |
| <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.41 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.61 | 4.61 | 5.22 |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| options | **RequestMerchantTransferOptions** | 是 | Web: x; 支付宝小程序: x |

#### options 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| mchId | string | 是 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 商户号 |
| package | string | 是 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 商家转账付款单跳转收款页 pkg 信息,商家转账付款单受理成功时返回给商户 |
| appId | string | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 商户 appId（微信平台appid），普通模式下必填，服务商模式下，appId 和 subAppId 二选一填写 |
| openId | string | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: x | 收款用户 openId， 对应传入的商户 appId 下，某用户的 openId |
| subAppId | string | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: x | 子商户 appId（微信平台子appid)，服务商模式下，appId 和 subAppId 二选一填写 |
| subMchId | string | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: x | 子商户号，服务商模式下必填 |
| success | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 接口调用成功的回调函数 |
| fail | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 接口调用失败的回调函数 |
| complete | (res: [RequestMerchantTransferGeneralCallbackResult](#requestmerchanttransfergeneralcallbackresult-values)) => void | 否 | Web: x; 微信小程序: 4.61; 支付宝小程序: x; Android: 4.61; iOS: 4.61; HarmonyOS: 5.22 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
