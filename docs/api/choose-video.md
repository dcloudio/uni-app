...
| extension | Array&lt;string&gt; | 否 |  | Web:  ; 微信小程序: 4.41; Android: x; iOS 系统版本: 10.0; iOS: x; HarmonyOS 系统版本: x; HarmonyOS: x | 根据文件拓展名过滤，每一项都不能是空字符串。默认不过滤。 |
...
| ~~albumMode~~ | string | 否 | "custom" | Web: x; 微信小程序:  ; Android: 4.33; iOS 系统版本: 10.0; iOS: x; HarmonyOS: x | 视频选择模式  **已废弃，仅为了向下兼容保留** |
