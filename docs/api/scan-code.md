...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| onlyFromCamera | boolean | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: 5.25 | 是否只能从相机扫码，不允许从相册选择图片 |
...
| charSet | string | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: - | 所扫码的字符集<br/> |
| path | string | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: - | 当所扫的码为当前小程序二维码时，会返回此字段，内容为二维码携带的 path<br/> |
| rawData | string | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: 5.25 | 原始数据，base64编码<br/> |
