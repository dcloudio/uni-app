...
| disableFallbackSharePage | boolean | 否 | Web: x; 微信小程序: 4.41 | 需要基础库： `3.7.7`<br/><br/>是否禁用分享页，默认为false<br/> |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| callback | (result: [RewardedVideoAdClose](#rewardedvideoadclose-values)) => void | 是 | Web: x | 
