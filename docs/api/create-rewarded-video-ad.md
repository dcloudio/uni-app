...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| adpid | string | 是 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 广告位 id |
| urlCallback | **UrlCallbackOptions** | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 服务器回调透传参数 |
| adUnitId | string | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 广告单元 id<br/> |
| disableFallbackSharePage | boolean | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 需要基础库： `3.7.1`<br/><br/>是否禁用分享页，默认为false<br/> |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| callback | (result: [VideoAdClose](#videoadclose-values)) => void | 是 | Web: x; 支付宝小程序: x | 
