...
### createRewardedVideoAd 兼容性 <Help /> 
| Web | 微信小程序 | 支付宝小程序 | Android | iOS |
| :- | :- | :- | :- | :- |
| <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.41 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.0 | 4.22 |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| option | **CreateRewardedVideoAdOptions** | 是 | Web: x; 支付宝小程序: x |

#### option 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| adpid | string | 是 | Web: x; 支付宝小程序: x | 广告位 id |
| urlCallback | **UrlCallbackOptions** | 否 | Web: x; 支付宝小程序: x | 服务器回调透传参数 |
| adUnitId | string | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 广告单元 id<br/> |
| disableFallbackSharePage | boolean | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 需要基础库： `3.7.7`<br/><br/>是否禁用分享页，默认为false<br/> |
| multiton | boolean | 否 | Web: x; 微信小程序: 4.41; 支付宝小程序: x | 需要基础库： `2.8.0`<br/><br/>是否启用多例模式，默认为false<br/> | 

##### urlCallback 的属性描述

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| userId | string | 否 | Web: x; 支付宝小程序: x | 透传到服务器端的userId |
| extra | string | 否 | Web: x; 支付宝小程序: x | 透传到服务器端的extra，不推荐设置过于复杂的字符串 |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| callback | (result: [RewardedVideoAdClose](#rewardedvideoadclose-values)) => void | 是 | Web: x; 支付宝小程序: x | 

##### RewardedVideoAdClose 的属性值 @rewardedvideoadclose-values 

| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| isEnded | boolean | 是 | Web: x; 支付宝小程序: x | true表示广告播放完毕或者达到发放奖励的条件 |
...
| 名称 | 类型 | 必填 | 兼容性 |
| :- | :- | :- |  :-: |
| callback | (result: [UTSJSONObject](/uts/buildin-object-api/utsjsonobject.md)) => void | 是 | Web: x; 支付宝小程序: x | 
