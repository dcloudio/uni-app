...
| $page | [UniPage](/api/unipage.md) | 是 |  | Web: 4.31; 微信小程序: √; Android: 4.31; iOS: 4.31; iOS uni-app x UTS 插件: x; HarmonyOS: 4.61 |  |
...
##### onLayoutChange 兼容性 
| Android | Android(Vapor) | iOS | iOS(Vapor) | HarmonyOS 系统版本 | HarmonyOS | HarmonyOS(Vapor) |
| :- | :- | :- | :- | :- | :- | :- |
| x | x | x | x | 6.0 | x | 5.0 |
