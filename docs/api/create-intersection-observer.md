...
| observeAll | boolean | 否 |  | 微信小程序: 4.41; Android: x; iOS: x; HarmonyOS: x | 是否同时观测多个参照节点（而非一个） |
...
| relativeRect | [ObserveNodeRect](#observenoderect-values) | 是 |  | Android: x; iOS: x; HarmonyOS: x | 参照区域的边界 |
