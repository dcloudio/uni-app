...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| appId | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 3.91; iOS: 4.11; iOS uni-app x UTS 插件: 4.11; HarmonyOS: 4.61 | manifest.json 中应用appid，即DCloud appid。<br/> |
| appName | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 3.91; iOS: 4.11; iOS uni-app x UTS 插件: 4.11; HarmonyOS: 4.61 | `manifest.json` 中应用名称。<br/> |
| appVersion | string | 否 |  | Web: 4.0; 微信小程序: 4.41; Android: 3.91; iOS: 4.11; iOS uni-app x UTS 插件: 4.11; HarmonyOS: 4.61 | `manifest.json` 中应用版本名称，如果离线打包注意修改修改index.kt中UniAppConfig类型中的版本名称[文档](https://doc.dcloud.net.cn/uni-app-x/native/use/android.html#%E6%8B%B7%E8%B4%9Dkt%E6%96%87%E4%BB%B6)。<br/> |
...
| packageName | string | 否 |  | Web: x; 微信小程序: 5.13; Android: 3.97; iOS: x; iOS uni-app x UTS 插件: x; HarmonyOS: 4.61 | 微信小程序: 小程序appId<br/>Android: 包名<br/>鸿蒙: bundleName<br/> |
