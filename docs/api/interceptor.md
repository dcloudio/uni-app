...
| :- | :- | :- | :- | :- | :- |
| 4.0 | 4.41 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 3.97 | 4.11 | 4.61 |
...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| name | string | 是 | 支付宝小程序: x | 需要拦截的 API 名称 |
| interceptor | Interceptor | 是 | 支付宝小程序: x | 拦截器 | 
...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| name | string | 是 | 支付宝小程序: x | 需要删除拦截器的 API 名称 |
| interceptor | Interceptor | 否 | 支付宝小程序: x | 拦截器 | 
