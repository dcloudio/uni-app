...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **OpenDialogPageOptions** | 是 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 打开 dialogPage 参数 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| url | string ([string.PageURIString](/uts/data-type.md#ide-string)) | 是 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 需要跳转的应用内非 tabBar 的页面的路径 , 路径后可以带参数 |
| animationType | string | 否 | none | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 窗口显示的动画类型<br/> |
| animationDuration | number | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 窗口关闭动画的持续时间，单位为 ms |
| disableEscBack | boolean | 否 | false | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 是否禁用按键盘 ESC 时关闭 |
| parentPage | [UniPage](/api/unipage.md) | 否 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 4.61; iOS: 4.61; iOS uni-app x UTS 插件: x; HarmonyOS 系统版本: 12; HarmonyOS(VDOM): 4.61 | 要绑定的父级页面实例 |
| triggerParentHide | boolean | 否 | false | Web: 4.41; 微信小程序: x; Android(VDOM): 4.41; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 是否触发父页面的 onHide 生命周期 |
| success | (result: [OpenDialogPageSuccess](#opendialogpagesuccess-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [OpenDialogPageFail](#opendialogpagefail-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: [OpenDialogPageComplete](#opendialogpagecomplete-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

##### animationType 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| auto | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 自动选择动画效果 |
| none | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 无动画效果 |
| slide-in-right | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从右侧横向滑动效果 |
| slide-in-left | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 左侧横向滑动效果 |
| slide-in-top | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从上侧竖向滑动效果 |
| slide-in-bottom | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从下侧竖向滑动效果 |
| fade-in | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从透明到不透明逐渐显示效果 |
| zoom-out | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从小到大逐渐放大显示效果 |
| zoom-fade-out | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从小到大逐渐放大并且从透明到不透明逐渐显示效果 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errCode | number | 是 |  | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 路由错误码<br/>- 4: 框架内部异常 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **CloseDialogPageOptions** | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 关闭 dialogPage 参数 |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| dialogPage | [UniPage](/api/unipage.md) | 否 |  | Web: 4.0; 微信小程序: x; Android(VDOM): 4.61; iOS: 4.61; iOS uni-app x UTS 插件: x; HarmonyOS 系统版本: 12; HarmonyOS(VDOM): 4.61 | 要关闭的 dialogPage 实例 |
| animationType | string | 否 | auto | Web: x; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 窗口关闭的动画类型<br/> |
| animationDuration | number | 否 |  | Web: x; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 窗口关闭动画的持续时间，单位为 ms |
| success | (result: [CloseDialogPageSuccess](#closedialogpagesuccess-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用成功的回调函数 |
| fail | (result: [CloseDialogPageFail](#closedialogpagefail-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用失败的回调函数 |
| complete | (result: [CloseDialogPageComplete](#closedialogpagecomplete-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; Android(VDOM): 4.31; iOS: 4.31; iOS uni-app x UTS 插件: 4.31; HarmonyOS(VDOM): 4.61; HarmonyOS(Vapor): 5.0 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| auto | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 自动选择动画效果 |
| none | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 无动画效果 |
| slide-out-right | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 横向向右侧滑出屏幕动画 |
| slide-out-left | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 横向向左侧滑出屏幕动画 |
| slide-out-top | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 竖向向上侧滑出屏幕动画 |
| slide-out-bottom | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 竖向向下侧滑出屏幕动画 |
| fade-out | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从不透明到透明逐渐隐藏动画 |
| zoom-in | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从大逐渐缩小关闭动画 |
| zoom-fade-in | Web:  ; 微信小程序: x; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   | 从大逐渐缩小并且从不透明到透明逐渐隐藏关闭动画 |
