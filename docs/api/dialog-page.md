...
| :- | :- | :- | :- | :- | :- |
| 4.31 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 4.31 | 4.31 | 4.61 |
...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| options | **OpenDialogPageOptions** | 是 | Web: 4.31; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 打开 dialogPage 参数 |
...
| disableEscBack | boolean | 否 | false | Web: 4.31; 微信小程序: x; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | 是否禁用按键盘 ESC 时关闭 |
...
| complete | (result: [OpenDialogPageComplete](#opendialogpagecomplete-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

##### animationType 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| auto | 微信小程序: x; 支付宝小程序: x | 自动选择动画效果 |
| none | 微信小程序: x; 支付宝小程序: x | 无动画效果 |
| slide-in-right | 微信小程序: x; 支付宝小程序: x | 从右侧横向滑动效果 |
| slide-in-left | 微信小程序: x; 支付宝小程序: x | 左侧横向滑动效果 |
| slide-in-top | 微信小程序: x; 支付宝小程序: x | 从上侧竖向滑动效果 |
| slide-in-bottom | 微信小程序: x; 支付宝小程序: x | 从下侧竖向滑动效果 |
| fade-in | 微信小程序: x; 支付宝小程序: x | 从透明到不透明逐渐显示效果 |
| zoom-out | 微信小程序: x; 支付宝小程序: x | 从小到大逐渐放大显示效果 |
| zoom-fade-out | 微信小程序: x; 支付宝小程序: x | 从小到大逐渐放大并且从透明到不透明逐渐显示效果 |
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| errCode | number | 是 | 微信小程序: x; 支付宝小程序: x | 路由错误码<br/>- 4: 框架内部异常 |
...
| 名称 | 类型 | 必填 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| options | **CloseDialogPageOptions** | 否 | Web: 4.31; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 关闭 dialogPage 参数 |
...
| fail | (result: [CloseDialogPageFail](#closedialogpagefail-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 接口调用失败的回调函数 |
| complete | (result: [CloseDialogPageComplete](#closedialogpagecomplete-values)) => void | 否 |  | Web: 4.31; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 接口调用结束的回调函数（调用成功、失败都会执行） | 

##### animationType 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| auto | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 自动选择动画效果 |
| none | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 无动画效果 |
| slide-out-right | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 横向向右侧滑出屏幕动画 |
| slide-out-left | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 横向向左侧滑出屏幕动画 |
| slide-out-top | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 竖向向上侧滑出屏幕动画 |
| slide-out-bottom | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 竖向向下侧滑出屏幕动画 |
| fade-out | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 从不透明到透明逐渐隐藏动画 |
| zoom-in | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 从大逐渐缩小关闭动画 |
| zoom-fade-in | Web: x; 微信小程序: x; 支付宝小程序: x; Android: 4.31; iOS: 4.31; HarmonyOS: 4.61 | 从大逐渐缩小并且从不透明到透明逐渐隐藏关闭动画 |
