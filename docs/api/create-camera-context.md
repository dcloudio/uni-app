...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| offAndroidCameraOriginalFrame | any | 是 |  | HarmonyOS: x | 停止获取Android平台的原始帧数据 |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| width | number | 否 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 图像数据矩形的宽度<br/> |
| height | number | 否 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 图像数据矩形的高度<br/> |
| data | [ArrayBuffer](/uts/buildin-object-api/arraybuffer.md) | 否 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 图像像素点数据，一维数组，每四项表示一个像素点的 rgba<br/> |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用成功的回调函数 |
| fail | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| zoom | number | 是 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 缩放级别，范围\[1, maxZoom]zoom 可取小数，精确到小数后一位。maxZoom 可在 initdone 返回值中获取。 |
| success | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用成功的回调函数<br/> |
| fail | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用失败的回调函数<br/> |
| complete | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| quality | string | 否 | 'normal' | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 成像质量<br/> |
| selfieMirror | boolean | 否 | true | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 前置摄像头拍照时是否开启镜像<br/> |
| success | (result: [CameraContextTakePhotoResult](#cameracontexttakephotoresult-values)) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用成功的回调函数 |
| fail | (error: [CameraContextFail](#cameracontextfail-values)) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| tempImagePath | string | 否 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 照片文件的临时路径 (本地路径)，安卓是jpg图片格式，ios是png。<br/>照片会存放到uni-media目录下[文件系统](https://doc.dcloud.net.cn/uni-app-x/api/file-system-spec.html)<br/> |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| timeout | number | 否 | 30 | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 录制时长上限，单位为秒 |
| selfieMirror | boolean | 否 | true | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 前置摄像头录制视频时是否开启镜像 |
| success | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用成功的回调函数<br/> |
| fail | (error: [CameraContextFail](#cameracontextfail-values)) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| compressed | boolean | 否 | false | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 启动视频压缩，压缩效果同chooseVideo<br/> |
| success | (result: [CameraContextStopRecordResult](#cameracontextstoprecordresult-values)) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用成功的回调函数<br/> |
| fail | (error: [CameraContextFail](#cameracontextfail-values)) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 | null | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| tempThumbPath | string | 否 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 封面图片文件的临时路径 (本地路径)<br/>图片会以jpg格式存放到uni-media目录下[文件系统](https://doc.dcloud.net.cn/uni-app-x/api/file-system-spec.html)<br/> |
| tempVideoPath | string | 否 |  | Android 系统版本: 4.4; Android: 4.61; iOS: 4.61; HarmonyOS 系统版本: x; HarmonyOS: x | 视频的文件的临时路径 (本地路径)<br/>视频将以mp4格式存放到uni-media目录下[文件系统](https://doc.dcloud.net.cn/uni-app-x/api/file-system-spec.html)<br/> |
