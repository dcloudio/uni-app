...
| :- | :- | :- | :- | :- | :- | :- | :- |
| 4.0 | 4.41 | 5.25 | 3.91 | 5.22 | 4.11 | 5.14 | 4.61 |
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| animation | boolean | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 是否需要动画效果 |
| success | (result: [ShowTabBarSuccess](#showtabbarsuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [ShowTabBarFail](#showtabbarfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [ShowTabBarComplete](#showtabbarcomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| :- | :- | :- |  :-: | :- |
| animation | boolean | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 是否需要动画效果 |
| success | (result: [HideTabBarSuccess](#hidetabbarsuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [HideTabBarFail](#hidetabbarfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [HideTabBarComplete](#hidetabbarcomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| index | number | 是 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tabBar的哪一项，从左边算起，索引从0开始 |
| success | (result: [ShowTabBarRedDotSuccess](#showtabbarreddotsuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [ShowTabBarRedDotFail](#showtabbarreddotfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [ShowTabBarRedDotComplete](#showtabbarreddotcomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| :- | :- | :- |  :-: | :- |
| index | number | 是 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tabBar的哪一项，从左边算起，索引从0开始 |
| success | (result: [HideTabBarRedDotSuccess](#hidetabbarreddotsuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [HideTabBarRedDotFail](#hidetabbarreddotfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [HideTabBarRedDotComplete](#hidetabbarreddotcomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| :- | :- | :- |  :-: | :- |
| index | number | 是 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tabBar的哪一项，从左边算起，索引从0开始 |
| text | string | 是 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 显示的文本，不超过 3 个半角字符 |
| success | (result: [SetTabBarBadgeSuccess](#settabbarbadgesuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [SetTabBarBadgeFail](#settabbarbadgefail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [SetTabBarBadgeComplete](#settabbarbadgecomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| :- | :- | :- |  :-: | :- |
| index | number | 是 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tabBar的哪一项，从左边算起，索引从0开始 |
| success | (result: [RemoveTabBarBadgeSuccess](#removetabbarbadgesuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [RemoveTabBarBadgeFail](#removetabbarbadgefail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [RemoveTabBarBadgeComplete](#removetabbarbadgecomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| :- | :- | :- | :- | :- | :- | :- | :- | :- |
| 4.0 | 4.41 | 5.25 | 3.91 | 5.22 | 4.11 | 5.14 | <a style="color:unset;" href="https://vote.dcloud.net.cn/#/?name=uni-app%20x">x</a> | 5.0 |
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| color | string ([string.ColorString](/uts/data-type.md#ide-string)) | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tab 上的文字默认颜色 |
| selectedColor | string ([string.ColorString](/uts/data-type.md#ide-string)) | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tab 上的文字选中时的颜色 |
| backgroundColor | string ([string.ColorString](/uts/data-type.md#ide-string)) | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tab 的背景色 |
| backgroundImage | string | 否 | 微信小程序: 4.41; 支付宝小程序: - | 图片背景 |
| backgroundRepeat | string | 否 | 微信小程序: 4.41; 支付宝小程序: - | 背景图平铺方式 |
...
| borderStyle | string | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tabbar上边框的颜色 |
| success | (result: [SetTabBarStyleSuccess](#settabbarstylesuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [SetTabBarStyleFail](#settabbarstylefail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [SetTabBarStyleComplete](#settabbarstylecomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
...
| 名称 | 类型 | 必备 | 兼容性 | 描述 |
| :- | :- | :- |  :-: | :- |
| index | number | 是 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tabBar 的哪一项，从左边算起，索引从0开始 |
| text | string | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | tab 上按钮文字 |
| iconPath | string | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 图片路径 |
| selectedIconPath | string | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 选中时的图片路径 |
| pagePath | string | 否 | Web: √; 微信小程序: x; 支付宝小程序: x; Android: x; iOS: x; HarmonyOS: x | 页面绝对路径 |
| iconfont | **SetTabBarItemIconFontOptions** | 否 | 微信小程序: 4.41; 支付宝小程序: - | 字体图标，优先级高于 iconPath |
| visible | boolean | 否 | 微信小程序: 4.41; 支付宝小程序: - | tab 是否显示 |
| success | (result: [SetTabBarItemSuccess](#settabbaritemsuccess-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用成功的回调函数 |
| fail | (result: [SetTabBarItemFail](#settabbaritemfail-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用失败的回调函数 |
| complete | (result: [SetTabBarItemComplete](#settabbaritemcomplete-values)) => void | 否 | 微信小程序: 4.41; 支付宝小程序: 5.25 | 接口调用结束的回调函数（调用成功、失败都会执行） | 
