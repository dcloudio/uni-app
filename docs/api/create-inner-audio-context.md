...
| Web | 微信小程序 | Android(VDOM) | iOS | iOS uni-app x UTS 插件 | HarmonyOS(VDOM) |
| :- | :- | :- | :- | :- | :- |
...
| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| duration | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 当前音频的长度（单位：s），只有在当前有合法的 src 时返回 |
| currentTime | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 当前音频的播放位置（单位：s），只有在当前有合法的 src 时返回 |
| paused | boolean | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 当前是是否暂停或停止状态，true 表示暂停或停止，false 表示正在播放 |
| src | string | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 音频的数据链接，用于直接播放 |
| startTime | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 音频开始播放的位置（单位：s） |
| buffered | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): x | 音频缓冲的时间点，仅保证当前播放时间点到此时间点内容已缓冲 |
| autoplay | boolean | 是 | false | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 是否自动开始播放，默认 false |
| loop | boolean | 是 | false | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 是否循环播放，默认 false |
| obeyMuteSwitch | boolean | 是 |  | Web: x; 微信小程序: 4.41; Android(VDOM): x; iOS: 5.0; iOS uni-app x UTS 插件: 5.0; HarmonyOS(VDOM): x | 是否遵循系统静音开关，当此参数为 false 时，即使用户打开了静音开关，也能继续发出声音，默认值 true |
| volume | number | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 音量。范围 0~1。 |
| playbackRate | number | 否 | 1.0 | Web: x; 微信小程序: 4.41; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): x | 播放的倍率。可取值： 0.5/0.8/1.0/1.25/1.5/2.0，默认值为1.0。（仅 App 支持） |
| cache | boolean | 是 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.71; iOS: 4.71; iOS uni-app x UTS 插件: 4.71; HarmonyOS(VDOM): x | 是否缓存线上音频资源，默认值为true，当设置false时，不会缓存资源到本地，直播地址需要主动设置为false |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| 1107601 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 系统错误 |
| 1107602 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 网络错误 |
| 1107603 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 文件错误 |
| 1107604 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 格式错误 |
| 1107605 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 未知错误 |
| 1107609 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.41; iOS uni-app x UTS 插件: 4.41; HarmonyOS(VDOM): 4.61 | 播放路径不能为空 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| option | **SetInnerAudioOptionOptions** | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM): x |  |

#### option 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| mixWithOther | boolean | 否 | true | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.73; iOS: 4.81; iOS uni-app x UTS 插件: 4.81; HarmonyOS 系统版本: 5.0.0(12); HarmonyOS(VDOM): x | 是否与其他音频混播，设置为 true 之后，不会终止其他应用或应用内的音频； 设置为false之后，会暂停背景音频和三方app音频 |
| speakerOn | boolean | 否 | true | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 5.0; iOS: 5.0; iOS uni-app x UTS 插件: 5.0; HarmonyOS 系统版本: 5.0.0(12); HarmonyOS(VDOM): x | true 代表用扬声器播放，false 代表听筒播放 |
| obeyMuteSwitch | boolean | 否 | true | Web: 4.0; 微信小程序: 4.41; Android(VDOM): x; iOS: 5.0; iOS uni-app x UTS 插件: 5.0; HarmonyOS 系统版本: 5.0.0(12); HarmonyOS(VDOM): x | （仅在 iOS 生效）是否遵循静音开关，设置为 false 之后，即使是在静音模式下，也能播放声音 |
| success | (result: SetInnerAudioOptionSuccess) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.73; iOS: 4.81; iOS uni-app x UTS 插件: 4.81; HarmonyOS(VDOM): x | 接口调用成功的回调函数 |
| fail | (result: [ICreateInnerAudioContextFail](#icreateinneraudiocontextfail-values)) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.73; iOS: 4.81; iOS uni-app x UTS 插件: 4.81; HarmonyOS(VDOM): x | 接口调用失败的回调函数 |
| complete | (result: any) => void | 否 |  | Web: 4.0; 微信小程序: 4.41; Android(VDOM): 4.73; iOS: 4.81; iOS uni-app x UTS 插件: 4.81; HarmonyOS(VDOM): x | 接口调用结束的回调函数（调用成功、失败都会执行） | 
