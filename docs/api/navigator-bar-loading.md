...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **ShowNavigationBarLoadingOptions** | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (result: [ShowNavigationBarLoadingSuccess](#shownavigationbarloadingsuccess-values)) => void | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |
| fail | (error: [ShowNavigationBarLoadingFail](#shownavigationbarloadingfail-values)) => void | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |
| complete | () => void | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  | 

#### ShowNavigationBarLoadingSuccess 的属性值 @shownavigationbarloadingsuccess-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errMsg | string | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |

#### ShowNavigationBarLoadingFail 的属性值 @shownavigationbarloadingfail-values 

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| errCode | number | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 统一错误码 |
| errSubject | string | 是 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 统一错误主题（模块）名称 |
| data | any | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   | 错误信息中包含的数据 |
...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **HideNavigationBarLoadingOptions** | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| success | (result: [HideNavigationBarLoadingSuccess](#hidenavigationbarloadingsuccess-values)) => void | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |
| fail | (error: [HideNavigationBarLoadingFail](#hidenavigationbarloadingfail-values)) => void | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  |
| complete | () => void | 否 |  | Web:  ; 微信小程序:  ; Android(VDOM): x; iOS: x; HarmonyOS(VDOM):   |  | 
