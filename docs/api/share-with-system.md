...
| 名称 | 类型 | 必填 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| options | **ShareWithSystemOptions** | 是 |  | Web: x; 微信小程序:  ; Android(VDOM):  ; iOS:  ; HarmonyOS(VDOM):   |  |

#### options 的属性描述

| 名称 | 类型 | 必备 | 默认值 | 兼容性 | 描述 |
| :- | :- | :- | :- |  :-: | :- |
| type | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: x; HarmonyOS(VDOM): x | 分享类型,默认为text。 |
| summary | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享的文字内容 |
| href | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享链接 |
| imageUrl | string | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享单个图片，仅支持本地路径 |
| imagePaths | Array&lt;string&gt; | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享图片，仅支持本地路径 |
| videoPaths | Array&lt;string&gt; | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享video，仅支持本地路径 |
| audioPaths | Array&lt;string&gt; | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享audio，仅支持本地路径 |
| filePaths | Array&lt;string&gt; | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享文件，仅支持本地路径 |
| success | (res: ShareWithSystemSuccess) => void | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | uni.shareWithSystem成功回调函数定义 |
| fail | (res: [ShareWithSystemFail](#sharewithsystemfail-values)) => void | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | uni.shareWithSystem失败回调函数定义 |
| complete | (res: any) => void | 否 |  | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | uni.shareWithSystem完成回调函数定义 | 

##### type 的属性描述

| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| text | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: x; HarmonyOS(VDOM): x | text类型 |
| image | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: x; HarmonyOS(VDOM): x | image类型 |
| video | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: x; HarmonyOS(VDOM): x | video类型 |
| audio | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: x; HarmonyOS(VDOM): x | audio类型 |
| file | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: x; HarmonyOS(VDOM): x | file类型 |
...
| 合法值 | 兼容性 | 描述 |
| :- |  :-: | :- |
| 1310600 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 取消分享 |
| 1310601 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 分享内容不可以为空 |
| 1310602 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 已经成功调用系统分享接口，系统分享出错 |
| 1310603 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 图片路径无效 |
| 1310604 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | 无效的链接 |
| 1310605 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | video 路径无效 |
| 1310606 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | file 文件不存在 |
| 1310607 | Web: x; 微信小程序:  ; Android(VDOM): 4.33; iOS: 4.33; HarmonyOS(VDOM): x | audio 路径无效 |
...
2. Android的系统分享，分享链接到微信只能以文本方式分享，如需方条链接需使用微信SDK，即[uni.share](./share.md)。iOS的系统分享可以分享方条链接。
