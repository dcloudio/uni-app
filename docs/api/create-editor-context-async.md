...
| fail | (error: [UniError](/err-spec.md#unierror)) => void | 否 | Web: 5.08; 微信小程序: 5.08; Android(VDOM): 5.08; Android(Vapor): x; iOS(VDOM): 5.08; iOS(Vapor): x; HarmonyOS: 5.08 | 接口调用失败的回调函数 |
