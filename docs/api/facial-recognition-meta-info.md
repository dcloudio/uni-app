...
### getFacialRecognitionMetaInfo 兼容性 <Help /> 
...
### startFacialRecognitionVerify 兼容性 <Help /> 
| Web | Android | iOS | HarmonyOS |
| :- | :- | :- | :- |
...
| screenOrientation | string | 否 | "port" | Web: x; Android: 3.9; iOS: 4.11; HarmonyOS: x | 认证时屏幕方向 |
