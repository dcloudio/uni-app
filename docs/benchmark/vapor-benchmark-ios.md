...
首先看录屏对比。
左边为`原生`，右边为`uni-app x蒸汽模式`。

点击链接：[长列表对比视频](https://www.bilibili.com/video/BV19zMt6ZEv2)
...
数据结论：死亡长列表帧率测试中，`uni-app x蒸汽模式`的平均帧率，在非高刷设备是原生SwiftUI的1.32倍，在高刷设备上是原生SwiftUI的**2.27倍**(111/49)。
