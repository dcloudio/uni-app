...
| backgroundColor | string ([string.ColorString](/uts/data-type.md#ide-string)) | "#ffffff" | 否 | Web: x; 微信小程序: 4.41; Android(VDOM): 3.99; Android(Vapor): 5.25; iOS(VDOM): 4.18; iOS(Vapor): 5.25; HarmonyOS(VDOM): x; HarmonyOS(Vapor): 5.0 | 下拉刷新显示出来的窗口的背景色（无下拉刷新时，此颜色无效果） |
