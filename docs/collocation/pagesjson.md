...
| midButton | [midButton 配置项列表](#tabbar-midbutton) |  | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 中间按钮 仅在 list 项为偶数时有效 |
...
| 属性 | 类型 | 默认值 | 必填 | 兼容性 | 描述 |
| :- | :- | :- | :- | :- | :- |
| width | string | "80px" | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 中间按钮的宽度，tabBar 其它项为减去此宽度后平分，默认值为与其它项平分宽度 |
| height | string | "80px" | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 中间按钮的高度，可以大于 tabBar 高度，达到中间凸起的效果 |
| text | string |  | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 中间按钮的文字 |
| iconPath | string ([string.ImageURIString](/uts/data-type.md#ide-string)) |  | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 中间按钮的图片路径 |
| iconWidth | string | "24px" | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 图标默认宽度（高度等比例缩放） |
| backgroundImage | string ([string.ImageURIString](/uts/data-type.md#ide-string)) |  | 否 | Web: 4.0; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 中间按钮的背景图片路径 |
| iconfont | object |  | 否 | Web: x; 微信小程序: x; Android: x; iOS: x; iOS(Vapor): x; HarmonyOS: x | 字体图标，优先级高于 iconPath |
