...
| appScheme | string | 否 |  | Web: x; 微信小程序: x; Android: 4.25; Android(Vapor): x; iOS: 4.25; HarmonyOS: x | 首次启动时的Scheme。返回值与App.onLaunch的回调参数一致<br/> |
...
| :- | :- | :- | :- |  :-: | :- |
| path | string | 是 |  |   | 应用启动页面路径 |
| appScheme | string | 否 |  | Web: x; 微信小程序: x; Android: 4.25; Android(Vapor): x; iOS: 4.25; HarmonyOS: x | 本次启动时的Scheme。返回值与App.onShow的回调参数一致<br/> |
