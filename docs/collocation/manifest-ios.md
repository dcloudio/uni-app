...
- HBuilderX 5.21 版本  
  ...
  ```
 - 注意：根据apple审核要求，支持任何三方登录，建议同时支持Apple 登录功能，否则审核失败； 具体请参考[Apple App Review Guidelines - Login Services说明](https://developer.apple.com/app-store/review/guidelines/#design)
