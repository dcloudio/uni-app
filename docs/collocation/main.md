...
hash: 0a6332093f8a475bf4eb4638602730d889a4f626d37c05d4c7371828377c8ef8
-->

# main.js/main.uts

`main.js/uts`是 uni-app 的入口文件。uni-app js引擎版是`main.js`，而uni-app x则是`main.uts`（蒸汽模式下，main.uts中可以直接写js代码）。以下一般用`main.js`泛指全部。
...
- uni-app x App平台暂不支持 i18n、vuex、pinia等 vue 官方插件 , 在 App 上使用需要使用 UTS 语言编写插件
- uni-app x 蒸汽模式下目前必须使用 main.uts 作为入口，但是该文件内部可以直接使用js代码。
