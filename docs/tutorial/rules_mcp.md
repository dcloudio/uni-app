...
## Codex
复制[AGENTS.md](https://gitcode.com/dcloud/uni-app-x-ai-rules/blob/main/AGENTS.md)文件到uni-app-x项目根目录下，Codex会默认读取该文件作为项目规则。

复制[.codex](https://gitcode.com/dcloud/uni-app-x-ai-rules/tree/main/.codex)目录到uni-app-x项目根目录下。其中`.codex/config.toml`已经包含项目级配置和MCP配置。
...
复制[.codex](https://gitcode.com/dcloud/uni-app-x-ai-rules/tree/main/.codex)目录到uni-app-x项目根目录下后，Codex会读取`.codex/config.toml`中的MCP配置：

```toml
[mcp_servers.uni-app-x]
command = "npx"
