...
hash: 43c7011eb01b3bd977e192bef799d8574185513b488fa1db8a3abb66d3c7c85f
-->
...
【重新运行】会触发全量构建，运行的是修改后的新代码。

如果要正常使用热更新功能，暂时请安装使用 DevEco Studio 6.1.0 或更低一点的版本，并等待新版本修复。
:::
