...
hash: 5e29bc5daef6c66d9946122016a292808bcb2c66b9b39ba04bbb38243661c89d
-->
...
- DevEco Studio [下载地址](https://developer.huawei.com/consumer/cn/download/deveco-studio?ha_source=Dcloud&ha_sourceId=89000448)
  ...
  - HBuilderX 4.61+ 要求 DevEco Studio 5.0.7.100+。
...
::: danger 注意
目前已知 DevEco Studio 6.1.1+ 版本有不兼容的变更，导致 HBuilderX 热更新功能失效，更新后跑的仍然是旧代码。

【重新运行】可临时解决问题，会触发全量构建，运行的是修改后的新代码。

如果要正常使用热更新功能，暂时请安装使用 DevEco Studio 6.1.0 或更低一点的版本，待新版本 DevEco Studio 修复此问题再使用。
:::
