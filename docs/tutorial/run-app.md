...
hash: 396db11f9b3465d06f79753c2e8d8361e829c58bae8e8d7f1507a2443e61717e
-->
...
#### arm64架构模拟器 @ios-simulator-arm64

Xcode 27 仅支持 Apple Silicon 设备。由于苹果官方暂未提供 Rosetta 模拟器下载，导致无法运行 x86_64 架构模拟器，仅支持 arm64 架构模拟器。  

> Xcode26 及以下版本可安装 Rosetta 模拟器以兼容 x86_64 架构模拟器，详情参考[iOS模拟器真机运行失败排查指南](https://uniapp.dcloud.net.cn/tutorial/run/installSimulator.html#ios-app-install-failed)

##### 5+ App/uni-app 项目  
受部分第三方 SDK 暂未适配 arm64 模拟器的影响，uni-app 项目暂不支持运行至 arm64 架构模拟器，仅支持 x86_64 架构模拟器。  

> **建议**：如已升级至较高版本 Xcode，建议降低 Xcode 版本安装 Rosetta 模拟器，或直接使用 iOS 真机 进行调试。  


##### uni-app x 项目  
**HBuilderX 5.26 及以下版本：** 标准基座仅包含 x86_64 架构。如需运行至 arm64 架构模拟器，请提交云端打包自定义基座，并勾选 “模拟器 (arm64)”，详情参考[iOS平台云端打包arm64架构模拟器自定义基座](https://uniapp.dcloud.net.cn/tutorial/run/installSimulator.html#%E4%BA%91%E7%AB%AF%E6%89%93%E5%8C%85%E6%94%AF%E6%8C%81-arm-%E6%9E%B6%E6%9E%84%E7%9A%84%E8%87%AA%E5%AE%9A%E4%B9%89%E5%9F%BA%E5%BA%A7)。  

**HBuilderX 5.27 及以上版本：** 标准基座已同时集成 arm64 与 x86_64 架构，可直接运行。  

**受限功能清单**  
由于部分第三方 SDK 暂未支持 arm64 模拟器，当编译并运行至 arm64 架构模拟器时，以下功能模块将不会包含，运行时调用会报错：  
+ 组件  
  - [camera](https://doc.dcloud.net.cn/uni-app-x/component/camera.html) 设置 mode 为 scanCode 时使用的 [相机组件扫码](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-ios.html#modulesscan)  
  - [live-player](https://doc.dcloud.net.cn/uni-app-x/component/live-player.html) 拉流  
  - [live-pusher](https://doc.dcloud.net.cn/uni-app-x/component/live-pusher.html) 推流  
  - [map](https://doc.dcloud.net.cn/uni-app-x/component/map.html) 地图中使用的 [腾讯地图](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-ios.html#maptencent)  
+ API  
  - [uni.getFacialRecognitionMetaInfo](https://doc.dcloud.net.cn/uni-app-x/api/facial-recognition-meta-info.html) 金融级实人认证  
  - [uni.getLocation](https://doc.dcloud.net.cn/uni-app-x/api/get-location.html) 获取当前位置中的 [腾讯定位](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-ios.html#locationtencent)  
  - [uni.getUniVerifyManager](https://doc.dcloud.net.cn/uni-app-x/api/get-univerify-manager.html) 一键登录  
  - [uni.login](https://doc.dcloud.net.cn/uni-app-x/api/sign-in.html) 登录中的 [微信登录](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-ios.html#oauthweixin)  
  - [uni-push](https://doc.dcloud.net.cn/uni-app-x/api/uni-push.html) 统一推送服务  
  - [uni.requestPayment](https://doc.dcloud.net.cn/uni-app-x/api/request-payment.html) 支付中的 [微信支付](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-ios.html#paymentweixin)  
  - [uni.requestMerchantTransfer](https://doc.dcloud.net.cn/uni-app-x/api/request-merchant-transfer.html) 转账确认收款  
  - [uni.scanCode](https://doc.dcloud.net.cn/uni-app-x/api/scan-code.html#scancode) 扫码  
  - [uni.share](https://doc.dcloud.net.cn/uni-app-x/api/share.html) 分享中的 [微信分享](https://doc.dcloud.net.cn/uni-app-x/collocation/manifest-ios.html#shareweixin)  
+ uni-ad（广告联盟）  
  以下渠道 SDK 不支持 arm64 模拟器  
  - 腾讯优量汇  
  - 百度百青藤广告联盟  
  - 旺脉
...
**注意事项**  
- 在 **HBuilderX 5.26 及以下版本** 中，若项目中包含 `uts 插件`，在 macOS 环境下本地编译暂不支持直接运行至 arm64 架构模拟器。如需调试，请提交云端打包自定义基座并勾选 “模拟器 (arm64)”。
