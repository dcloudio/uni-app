...
`DCloud`公司拥有490万开发者用户，几十万应用案例、9.6亿手机端月活用户，数千款uni-app插件、70+微信/qq群。阿里小程序工具官方内置uni-app（[详见](https://docs.alipay.com/mini/ide/0.70-stable)），腾讯课堂官方为uni-app录制培训课程（[详见](https://ask.dcloud.net.cn/article/35640)），开发者可以放心选择。
...
<div class="uniapp-home-content">
    <div class="uniapp-home-content-item">
      ...
      <div class="uniapp-home-content-item-header">
        ...
        <p class="uniapp-home-content-item-text">几十万应用、uni统计月活9.6亿、70+微信/qq群、更高的百度指数</p>
