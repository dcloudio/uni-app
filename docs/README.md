...
- 原生已经够快了，还需要更好的渲染性能吗？\
	...
	原生开发，并不是天然高性能，需要理解很多概念，有经验才能做好性能优化。\
	在 AI Coding 时代，一不小心 AI 就会写出满足功能需求但降低性能的代码，还需投入经验丰富的原生工程师来review。\
	而 uni-app x 提供了性能优秀的声明式框架，可以显著降低让应用性能优秀的人力门槛和人月代价。\
	优秀的底层框架留给了上层“造”的空间，让业务代码可以快速生成上线，免除原生开发中投入高级原生工程师打磨性能的投入。
...
- 不跨平台，uni-app x 有优势吗？
	...
	* 更好的App框架：
		+ vue的模板写法，是一种AI熟悉的、简单而成熟的声明式写法。比如原生的命令式写法的开发效率高的多，而原生提供的声明式写法又性能不佳。在AI时代，由于声明式的约束，让AI犯错的机会也少的多、消耗的token也少的多。
		+ uni-app x 支持开发期间热刷新。而原生开发，改一下代码都得等很久，非常低效。
		+ 用 uni-app x 开发性能还比原生渲染更高，那确实没必要用原生开发了。
