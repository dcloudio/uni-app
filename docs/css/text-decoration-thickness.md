...
| 名称 | 兼容性 | 描述 |
| :- | :- | :- |
| auto | Web: 4.0; Android: x; iOS: x; HarmonyOS: x | 自动为文本装饰线选择合适的粗细。 |
| from-font | Web: 4.0; Android: x; iOS: x; HarmonyOS: x | 如果字体文件中包含了首选的粗细值，则使用字体文件的粗细值。如果字体文件中没有包含首选的粗细值，则效果和设置为 auto 一样。 |
