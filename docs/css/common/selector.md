...
| 名称 | 示例 | Web | Android | iOS 系统版本 | iOS | HarmonyOS | HarmonyOS(Vapor) | 描述 |
| :- | :- | :- | :- | :- | :- | :- | :- | :- |
| 通配选择器 | * {} | 4.0 | x | 9.0 | x | x | x |  |
| 类选择器 | .class {} | 4.0 | 3.9 | 9.0 | 4.11 | 4.61 | 5.0 |  |
| 元素选择器 | \[tag]{} | 4.0 | x | 9.0 | x | x | x |  |
| ID 选择器 | #\[id]{} | 4.0 | x | 9.0 | x | x | x |  |
| 属性选择器 | \[attr]{} | 4.0 | x | 9.0 | x | x | x |  |
| 分组选择器 | .a, .b {} | 4.0 | 3.9 | 9.0 | 4.11 | 4.61 | 5.0 |  |
| 直接子代选择器 | .a > .b {} | 4.0 | 3.9 | 9.0 | 4.11 | 4.61 | x |  |
| 后代选择器 | .a .b {} | 4.0 | 3.9 | 9.0 | 4.11 | 4.61 | x |  |
| 一般兄弟选择器 | .a ~ .b {} | 4.0 | 3.9 | 9.0 | 4.11 | 4.61 | x |  |
| 紧邻兄弟选择器 | .a + .b {} | 4.0 | 3.9 | 9.0 | 4.11 | 4.61 | x |  |
| 伪类选择器 | :active {} | 4.0 | x | 9.0 | x | x | x |  |
| 伪元素选择器 | ::before {} | 4.0 | x | 9.0 | x | x | x |  |
