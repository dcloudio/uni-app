...
鸿蒙仍为nova12 api21，最大帧率120；iOS仍为iPhone SE2(iOS26.5)，iOS设备不支持高刷，最大帧率为60。
...
- iOS平台死亡长列表帧率测试中，`uni-app x蒸汽模式`的帧率是原生SwiftUI的1.32倍。
