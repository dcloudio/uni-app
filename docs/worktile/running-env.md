...
hash: 6720282473ebaaf12d45e0f889d1b93c6685d01b776a35b0c4c71d848cc9d2dd
-->
...
- 编译期判断
  编译期判断，即条件编译，不同平台在编译出包后已经是不同的代码。详见：[条件编译](https://uniapp.dcloud.net.cn/tutorial/platform.html)
