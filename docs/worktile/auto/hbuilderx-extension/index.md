---
source: https://gitcode.com/dcloud/docs-common/edit/main/worktile/auto/hbuilderx-extension/index.md
---

<!-- GENERATED BY docs-sync
hash: 8f67c547ce066773c20be79423a6c08fc52c3a4bf5d7bc3c88b0fa3ab9e3a1b5
-->
...
> 如果无法获取到设备信息，请[参考](https://uniapp.dcloud.net.cn/tutorial/run/run-app-faq.html)
...
1. `env.js` 是对`jest.config.js`文件`testEnvironmentOptions`节点的抽离和扩充。
...
如果您需要运行自定义基座，需要将`is-custom-runtime`设置为true，并需要填写平台节点下的appid、package、executablePath
