...
hash: b656ec8b986c8d8140b30fc234ee829deb91f5a73bd92b6889fdc840ff47433e
-->

# uts插件 - uni-app兼容模式组件（原“组件插件”）开发

> HBuilderX3.6.18 及以上版本支持，app-harmony平台不支持此类型插件，uni-app x 蒸汽模式不支持此类型插件

uni-app兼容模式组件目前主要用于uni-app项目，uni-app x推荐使用标准模式组件。
