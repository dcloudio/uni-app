---
source: https://gitcode.com/dcloud/docs-common/edit/main/plugin/uni_modules.md
---

<!-- GENERATED BY docs-sync
hash: 455662aeddbb39a19a84ce4f1b3337ca8d88b253144ff46d5bdea8681c710ed7
-->
...
由于uni-app有自己的项目目录结构规范（uni-app[详见](https://uniapp.dcloud.net.cn/tutorial/project.html)、uni-app x[详见](https://doc.dcloud.net.cn/uni-app-x/project.html)），
...
```json
{
    ...
    "uni_modules": {
        // ......
        "platforms": { // 平台兼容性废弃原y(Yes)、n(No)、u(Unknown)的规范，调整为: √ 表示支持；x 表示不支持；- 表示不确定；默认为 -
            "cloud": {
                "tcb": "√",
                "aliyun": "√",
                "alipay": "x"
