...
* App平台 蒸汽模式 新增 组件 list-view 支持默认显示到底部 [文档](https://doc.dcloud.net.cn/uni-app-x/component/list-view.html) <https://issues.dcloud.net.cn/pages/issues/detail?id=32464>
...
* App平台 蒸汽模式 新增 scheme启动及获取参数，可实现直达 [文档](https://doc.dcloud.net.cn/uni-app-x/collocation/app.html#%E5%8F%82%E6%95%B0-2) <https://issues.dcloud.net.cn/pages/issues/detail?id=32465> <https://issues.dcloud.net.cn/pages/issues/detail?id=32459> <https://issues.dcloud.net.cn/pages/issues/detail?id=31788>
...
* App平台 蒸汽模式 修复 CSS useComputedStyle 支持 css 变量。同时基于useComputedStyle的input、textarea、loading也支持了css变量 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=31606)
...
##### uts插件
* Android平台 蒸汽模式 优化 uts插件通道通信性能 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=31458)
...
* 【重要】微信小程序平台 新增 支持 微信AI [文档](https://uniapp.dcloud.net.cn/tutorial/mp-weixin-ai-develop.html)
...
* Web平台 修复 CSS page 选择器在 app.uvue 中不生效 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=30828)
...
* App平台 蒸汽模式 新增 组件 sticky-section 支持 push-pinned-header 属性控制堆叠效果 [文档](https://doc.dcloud.net.cn/uni-app-x/component/sticky-section.html) <https://issues.dcloud.net.cn/pages/issues/detail?id=30661>
* App平台 蒸汽模式 新增 组件 button 支持 loading-text-class 自定义 loading 状态下的文字样式 [文档](https://doc.dcloud.net.cn/uni-app-x/component/button.html) <https://issues.dcloud.net.cn/pages/issues/detail?id=30279>
...
* App平台 蒸汽模式 修复 5.14版本引发的 组件 list-view list-item复用时尺寸变化记录错误导致界面异常 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=31423)
...
* App平台 蒸汽模式 修复 组件 input 某些情况宽度不符合预期 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=30793)
...
* 鸿蒙平台 蒸汽模式 修复 UniPage API 华为云测闪退，报 ecma_vm cannot run in multi-thread 错误 [详情](https://issues.dcloud.net.cn/pages/issues/detail?id=31092)
...
* App-iOS平台 新增 API uni-push [详情](https://doc.dcloud.net.cn/uni-app-x/api/push.html)
