...
|美数			|ms-sdk_2.5.16.5_release.aar<br/>uniad-ms-adapter_2.0.0.2_release.aar																										|androidx.cardview:cardview:1.0.0<br/>com.google.code.gson:gson:2.8.5<br/>com.squareup.okhttp3:okhttp:3.12.1																																													|-																									|可选，国内广告				|
