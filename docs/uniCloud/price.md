...
腾讯云针对每个账号提供了一个有免费额度的服务空间，以方便开发测试。具体额度请阅读下方[腾讯云付费版包月套餐](uniCloud/price.md?id=price-month)

> 腾讯云在近期（2021年1月21日）因业务调整，对基础版1套餐（原免费版）进行下线，并向用户提供免费版和特惠基础版1，满足不同场景下的用户需求，免费版套餐适用于产品测试及产品体验场景。本次调整不会影响现已开通的免费服务空间。新开通的免费服务空间、付费套餐自动降配到的免费服务空间均会使用新版的免费额度，以下是新旧免费额度对比
...
- 被设置自动降配的服务空间到期之后并不一定会自动降配，如果你的资源超出了免费版的额度则无法降配
...
> 基础版1为原免费套餐，现已不可开通。新的免费额度将以下表的免费版为准

|资源分类			|资源细项				|基础版1			|免费版				|特惠基础版		|基础版2			|专业版1			|专业版2			|旗舰版1			|
|:-:					|:-:						|:-:					|:-:					|:-:					|:-:					|:-:					|:-:					|:-:					|
...
|							|备份保留天数		|7天					|7天					|7天					|14天					|14天					|14天					|14天					|
|							|指定回档时间		|×						|×						|×						|√						|√						|√						|√						|
...
- **函数数量限制：**实际项目中由于clientDB和单路由云函数，只会用到几个云函数，达不到限制数字
