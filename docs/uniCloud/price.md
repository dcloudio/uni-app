...
腾讯云在近期（2021年1月21日）因业务调整，对基础版1套餐（原免费版）进行下线，并向用户提供免费版和特惠基础版1，满足不同场景下的用户需求，免费版套餐适用于产品测试及产品体验场景。

本次调整不会影响现已开通的免费服务空间。新开通的免费服务空间、付费套餐自动降配到的免费服务空间均会使用新版的免费额度，以下是新旧免费额度对比

|资源类别	|子类目					|限制（旧免费版）	|限制（新免费版）	|
|:-:			|:-:						|:-:							|:-:							|
|云函数		|硬件资源用量		|4万GBs/月				|1000GBs/月				|
|					|外网出流量			|1GB/月						|1GB/月						|
|					|云函数并发限制	|1000个/云函数		|1000个/云函数		|
|					|云函数数目			|49个							|9个							|
|云存储		|容量						|5GB							|5GB							|
|					|下载操作次数		|150万/月					|2000/月					|
|					|上传操作次数		|60万/月					|1000/月					|
|					|CDN回源流量		|5GB/月						|1GB/月						|
|CDN			|CDN流量				|5GB/月						|1GB/月						|
|云数据库	|容量						|2GB							|2GB							|
|					|读操作数				|5万次/天					|500次/天					|
|					|写操作数				|3万次/天					|300次/天					|
|					|集合限制				|50个							|15个							|
...
|							|指定回档时间		|×				|×			|×					|√				|√				|√				|√				|
|售价（元/月）|-							|免费			|免费		|免费				|30				|104			|390			|860			|
