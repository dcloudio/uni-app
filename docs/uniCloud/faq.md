...
腾讯云已支持云函数URL化，很快阿里云也会补齐。

如果是在浏览器里访问，也可以用uni-app做个web页面，通过这个url来操作云函数。插件市场有一个做好的样例，详见[https://ext.dcloud.net.cn/plugin?id=1360](https://ext.dcloud.net.cn/plugin?id=1360)
