...
hash: 1374fae51e0d227c23e77e55f8aad50c54c79646fdba17b2f7ee254c2f7f5264
-->
...
在 HBuilderX 的 **Design 预览**中，可以直接选择页面元素并添加到聊天输入区，适合只修改某个按钮、文字、图片或局部区域：
...
手机端连接电脑上的 uni-agent 后，也可以进入 **Design** 模式生成和修改设计。使用前请保持电脑上的 HBuilderX 和手机控制服务正常运行，并完成移动端配对；连接方法见 [移动端](#mobile)。如果当前电脑端版本不支持 Design，手机端不会显示 Design 入口，请先升级 HBuilderX 和 uni-agent 插件。
