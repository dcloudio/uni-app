...
hash: 3669cfd200a90f05c513e297cff0476fea26d18de59b7ee80bbf25e6660211ce
-->
...
| 模型来源 | 档位名称 | 相对消耗速率 |
| --- | --- | --- |
| **默认模型**<br><br>*(推荐优先使用)* | **1x** | **1x (基准)** | 
|  | **2x** | 2x | 
| **DeepSeek**<br><br>*(国产化/敏感出境)* | **Flash** | **最低 (< 1x)** |
|  | **Pro** | 约 **1x** | 
| **聚合中转**<br><br>*(第三方线路)* | **1x** | 约 **2x** | 
|  | **2x** | 约 **4x** | 
| **智谱**<br><br>*(国产 GLM 线路)* | **GLM 5.2** | 约 **7x** | 
