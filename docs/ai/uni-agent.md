...
hash: 70ac3880b4c1aacc66ca876bd3553b9ad6eb839e3c16c4a8c4bbb099c5dd9b98
-->
...
| **DeepSeek**<br><br>*(国产化/敏感出境)* | **V4 Flash** | **(0.35x)** | 使用 `deepseek-v4-flash`。响应极快，适合日常问答、轻量代码生成、简单错误定位和短上下文任务。 | ❌ 不支持图片识别。 |
|  | **V4 Pro** | 约 **1x** | 使用 `deepseek-v4-pro`。适合复杂需求拆解、长上下文分析、跨文件修改和高难度排障。 | ❌ 不支持图片识别。 |
