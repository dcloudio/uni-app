...
hash: 00f0bc795f01573300d10bfc28239ca92e8ea7fa0e0236c8949344885eeb0318
-->
...
| **DeepSeek**<br><br>*(国产化/敏感出境)* | **V4 Flash** | 约 **闲时0.35x，高峰0.7x** | 使用 `deepseek-v4-flash`。响应极快，适合日常问答、轻量代码生成、简单错误定位和短上下文任务。 | ❌ 不支持图片识别。 |
|  | **V4 Flash 识图** | 约 **闲时0.35x，高峰0.7x** | 使用 `deepseek-v4-flash-vision-exp`。在快速响应和低消耗的基础上支持图片识别，适合图像理解、界面截图分析和包含图片的代码问题定位。 | ✅ 支持图片识别。 |
...
|  | **GLM 5.3 Flash** | 折扣期间约 **0.15x** | 支持多模态，适合日常问答、代码生成、图片理解和问题分析。 | 8月27日-9月12日0时期间，限时 5 折；折扣期间综合倍率约 0.15x。 |
